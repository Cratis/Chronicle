...
using context = Cratis.Chronicle.Integration.Specifications.for_ReadModels.when_getting_instances.without_event_count.context;

namespace Cratis.Chronicle.Integration.Specifications.for_ReadModels.when_getting_instances;

[Collection(ChronicleCollection.Name)]
public class without_event_count(context context) : Given<context>(context)
{
    ...
    [Fact] void should_have_value_from_second_event() => Context.Results.First().Value.ShouldEqual(Context.SecondEvent.Value);
}
