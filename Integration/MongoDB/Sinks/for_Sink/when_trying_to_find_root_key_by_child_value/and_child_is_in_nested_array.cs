...
public class and_child_is_in_nested_array : given.a_sink_with_test_data
{
    Guid _rootKey;
    ...
    public and_child_is_in_nested_array(XUnit.Integration.ChronicleInProcessFixture fixture) : base(fixture)
    {
    }
