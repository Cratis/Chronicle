...
using context = Cratis.Chronicle.Integration.for_ReadModels.when_getting_instance_with_unspecified_key.and_multiple_event_sources_exist.context;

namespace Cratis.Chronicle.Integration.for_ReadModels.when_getting_instance_with_unspecified_key;
