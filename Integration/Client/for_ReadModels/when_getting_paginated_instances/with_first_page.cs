...
using context = Cratis.Chronicle.Integration.for_ReadModels.when_getting_paginated_instances.with_first_page.context;
using given = Cratis.Chronicle.Integration.for_ReadModels.given;

namespace Cratis.Chronicle.Integration.for_ReadModels.when_getting_paginated_instances;

[Collection(ChronicleCollection.Name)]
public class with_first_page(context context) : Given<context>(context)
{
    ...
    [Fact] void should_echo_back_page_zero() => Context.Response.Page.ShouldEqual(0);
