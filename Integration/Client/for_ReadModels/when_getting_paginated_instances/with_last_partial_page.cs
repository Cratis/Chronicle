...
using context = Cratis.Chronicle.Integration.for_ReadModels.when_getting_paginated_instances.with_last_partial_page.context;
...
public class with_last_partial_page(context context) : Given<context>(context)
{
