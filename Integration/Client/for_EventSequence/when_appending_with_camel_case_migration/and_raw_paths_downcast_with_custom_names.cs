...
using context = Cratis.Chronicle.Integration.for_EventSequence.when_appending_with_camel_case_migration.and_raw_paths_downcast_with_custom_names.context;

namespace Cratis.Chronicle.Integration.for_EventSequence.when_appending_with_camel_case_migration;

[Collection(ChronicleCollection.Name)]
public class and_raw_paths_downcast_with_custom_names(context context) : Given<context>(context)
{
    public class context(ChronicleFixture fixture) : given.a_camel_case_client(fixture, "raw-downcast")
    {
