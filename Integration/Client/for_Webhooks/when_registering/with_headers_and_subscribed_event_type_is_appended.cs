...
using context = Cratis.Chronicle.Integration.for_Webhooks.when_registering.with_headers_and_subscribed_event_type_is_appended.context;

namespace Cratis.Chronicle.Integration.for_Webhooks.when_registering;

[Collection(ChronicleCollection.Name)]
public class with_headers_and_subscribed_event_type_is_appended(context context) : Given<context>(context)
{
    public class context(ChronicleFixture chronicleInProcessFixture)
