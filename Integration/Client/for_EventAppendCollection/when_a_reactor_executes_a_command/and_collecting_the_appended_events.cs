...
using context = Cratis.Chronicle.Integration.for_EventAppendCollection.when_a_reactor_executes_a_command.and_collecting_the_appended_events.context;

namespace Cratis.Chronicle.Integration.for_EventAppendCollection.when_a_reactor_executes_a_command;

[Collection(ChronicleCollection.Name)]
public class and_collecting_the_appended_events(context context) : Given<context>(context)
{
    public class context(ChronicleFixture fixture) : given.a_reactor_that_executes_a_command_scope(fixture)
    {
        async Task Because()
        {
