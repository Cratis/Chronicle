...
public static class KnownValues
{
    ...
    public static LineString LineStringValue = new([new Point(42.123, 10.456), new Point(43.456, 11.789)]);
    public static Polygon PolygonValue = new(
        new LinearRing([new Point(0, 0), new Point(10, 0), new Point(10, 10), new Point(0, 10), new Point(0, 0)]),
        []);
}
