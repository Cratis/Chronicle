...
using context = Cratis.Chronicle.Integration.Projections.Scenarios.ModelBound.when_projecting_with_nested_object.updating_the_nested_object.context;
...
public class updating_the_nested_object(context context) : Given<context>(context)
{
    public class context(ChronicleFixture fixture) : Specification(fixture)
    {
        ...
        async Task Because()
        {
            ...
            Result = await EventStore.ReadModels.GetInstanceById<Slice>(SliceId.ToString());
        }
    }
