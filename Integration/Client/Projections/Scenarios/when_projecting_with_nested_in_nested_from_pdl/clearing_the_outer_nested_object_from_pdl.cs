...
/// <summary>
/// Verifies that the outer <c language="csharp">clear with PdlDeepNestedCommandCleared</c> directive
/// compiles into a <c language="csharp">RemovedWith</c> entry on the outer nested definition, while the
/// inner block has its own (different) <c language="csharp">RemovedWith</c>. This is the PDL-level counterpart
/// of Phase 1's <c language="csharp">when_projecting_with_nested_in_nested.clearing_the_outer_nested_object</c>,
