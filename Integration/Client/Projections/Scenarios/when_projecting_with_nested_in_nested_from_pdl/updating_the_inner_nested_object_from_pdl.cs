...
/// <summary>
/// Verifies that PDL compilation handles a second <c language="csharp">from</c> on the inner nested block —
/// the validation update event — and maps its renamed property (<c language="csharp">newRules</c>) onto the
/// same <c language="csharp">rules</c> read-model property. This is the PDL-level counterpart of Phase 1's
/// <c language="csharp">when_projecting_with_nested_in_nested.updating_the_inner_nested_object</c>, which
