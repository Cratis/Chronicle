...
using materialized_context = Cratis.Chronicle.Integration.Projections.Scenarios.when_updating_projection_definition.for_materialized_projection.context;

namespace Cratis.Chronicle.Integration.Projections.Scenarios.when_updating_projection_definition;

[Collection(ChronicleCollection.Name)]
public class for_immediate_projection(materialized_context context) : Given<materialized_context>(context)
{
