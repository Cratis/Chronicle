...
using context = Cratis.Chronicle.Integration.Projections.Scenarios.when_registering_multiple_projections.all_become_active.context;

namespace Cratis.Chronicle.Integration.Projections.Scenarios.when_registering_multiple_projections;
