...
using context = Cratis.Chronicle.Integration.Projections.Scenarios.when_projecting_properties.using_constant_key_with_decrement.context;
...
{
    public class context(ChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<DecrementWithConstantKeyProjection, CounterReadModel>(chronicleFixture)
    {
