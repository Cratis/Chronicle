...
using context = Cratis.Chronicle.Integration.Projections.Scenarios.when_projecting_properties.with_auto_mapping.context;
...
public class with_auto_mapping(context context) : Given<context>(context)
{
    ...
    [Fact] void should_set_the_coordinate_value() => Context.Result.CoordinateValue.ShouldEqual(Context.EventAppended.CoordinateValue);
