...
using context = Cratis.Chronicle.Integration.for_Reducers.when_appending_event_with_filter_tags.and_event_does_not_have_matching_tag.context;

namespace Cratis.Chronicle.Integration.for_Reducers.when_appending_event_with_filter_tags;
