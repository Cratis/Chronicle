...
using context = Cratis.Chronicle.Integration.for_Reactors.when_appending_event.and_not_waiting_for_observer_to_be_active.context;

namespace Cratis.Chronicle.Integration.for_Reactors.when_appending_event;
