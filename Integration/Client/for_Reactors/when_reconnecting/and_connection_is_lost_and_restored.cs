...
using context = Cratis.Chronicle.Integration.for_Reactors.when_reconnecting.and_connection_is_lost_and_restored.context;

namespace Cratis.Chronicle.Integration.for_Reactors.when_reconnecting;
