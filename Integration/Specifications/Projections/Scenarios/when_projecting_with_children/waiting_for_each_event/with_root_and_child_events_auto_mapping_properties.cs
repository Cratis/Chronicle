...
using context = Cratis.Chronicle.Integration.Specifications.Projections.Scenarios.when_projecting_with_children.waiting_for_each_event.with_root_and_child_events_auto_mapping_properties.context;
...
public class with_root_and_child_events_auto_mapping_properties(context context) : Given<context>(context)
{
    ...
    public class context(IChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<GroupProjectionWithAutoMapping, Group>(chronicleFixture)
    {
