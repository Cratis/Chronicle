...
using context = Cratis.Chronicle.Integration.Specifications.Projections.Scenarios.when_projecting_properties.using_constant_key_with_count.context;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_projection_and_events_appended_to_it<CountWithConstantKeyProjection, CounterReadModel>(chronicleInProcessFixture)
    {
