...
using context = Cratis.Chronicle.Integration.Specifications.Projections.Scenarios.when_projecting_properties.with_simple_set_operations.context;
...
{
    public class context(IChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<SetPropertiesProjection, ReadModel>(chronicleFixture)
    {
