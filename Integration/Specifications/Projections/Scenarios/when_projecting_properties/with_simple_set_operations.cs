...
{
    public class context(ChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<SetPropertiesProjection, ReadModel>(chronicleFixture)
    {
