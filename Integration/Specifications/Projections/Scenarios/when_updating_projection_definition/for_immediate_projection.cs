...
using context = Cratis.Chronicle.Integration.Specifications.Projections.Scenarios.when_updating_projection_definition.for_immediate_projection.context;
...
{
    public class context(ChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<ImmediateProjection, TestReadModel>(chronicleFixture)
    {
