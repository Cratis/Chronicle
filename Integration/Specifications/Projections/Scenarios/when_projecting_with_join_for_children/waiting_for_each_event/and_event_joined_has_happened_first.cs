...
using context = Cratis.Chronicle.Integration.Specifications.Projections.Scenarios.when_projecting_with_join_for_children.waiting_for_each_event.and_event_joined_has_happened_first.context;
...
public class and_event_joined_has_happened_first(context context) : Given<context>(context)
{
    ...
    public class context(IChronicleFixture chronicleFixture) : given.a_projection_and_events_appended_to_it<UserProjection, User>(chronicleFixture)
    {
