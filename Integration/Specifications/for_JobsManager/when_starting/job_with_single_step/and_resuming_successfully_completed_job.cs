...
using Cratis.Monads;
using context = Cratis.Chronicle.Integration.Specifications.for_JobsManager.when_starting.job_with_single_step.and_resuming_successfully_completed_job.context;
