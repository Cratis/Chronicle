...
using context = Cratis.Chronicle.Integration.Specifications.for_Reducers.when_handling_event.and_reducer_is_synchronous_and_returns_null_as_model_result.context;
...
{
    public class context(IChronicleFixture chronicleFixture) : given.a_reducer_able_to_delete<SynchronousReducerHandlingDeleteAsNull>(chronicleFixture);
