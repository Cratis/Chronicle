...
using context = Cratis.Chronicle.InProcess.Integration.for_Reducers.when_handling_event.and_reducer_is_asynchronous_and_returns_null_as_model_result.context;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_reducer_able_to_delete<AsynchronousReducerHandlingDeleteAsNull>(chronicleInProcessFixture);
