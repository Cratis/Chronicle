...
using context = Cratis.Chronicle.InProcess.Integration.for_EventSequence.when_getting_next_sequence_number.with_no_events_appended.context;

namespace Cratis.Chronicle.InProcess.Integration.for_EventSequence.when_getting_next_sequence_number;
