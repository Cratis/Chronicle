...
[FromEvent<CommandSetOnSlice>]
[FromEvent<CommandRenamedOnSlice>]
[ClearWith<CommandClearedFromSlice>]
public record SliceCommandItem(
    [SetFrom<CommandRenamedOnSlice>(nameof(CommandRenamedOnSlice.NewName))]
    string Name,
    string Schema);
