...
using context = Cratis.Chronicle.InProcess.Integration.Projections.Scenarios.when_projecting_properties.with_simple_set_operations.context;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_projection_and_events_appended_to_it<SetPropertiesProjection, ReadModel>(chronicleInProcessFixture)
    {
