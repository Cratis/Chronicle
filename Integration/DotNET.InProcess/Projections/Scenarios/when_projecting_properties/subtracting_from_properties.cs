...
using context = Cratis.Chronicle.InProcess.Integration.Projections.Scenarios.when_projecting_properties.subtracting_from_properties.context;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_projection_and_events_appended_to_it<SubtractingFromPropertiesProjection, ReadModel>(chronicleInProcessFixture)
    {
