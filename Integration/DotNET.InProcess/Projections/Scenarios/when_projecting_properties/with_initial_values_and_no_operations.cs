...
using context = Cratis.Chronicle.InProcess.Integration.Projections.Scenarios.when_projecting_properties.with_initial_values_and_no_operations.context;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_projection_and_events_appended_to_it<ProjectionWithInitialValues, ReadModel>(chronicleInProcessFixture)
    {
