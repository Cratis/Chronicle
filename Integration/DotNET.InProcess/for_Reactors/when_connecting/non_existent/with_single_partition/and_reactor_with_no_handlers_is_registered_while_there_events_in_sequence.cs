...
using context = Cratis.Chronicle.InProcess.Integration.for_Reactors.when_connecting.non_existent.with_single_partition.and_reactor_with_no_handlers_is_registered_while_there_events_in_sequence.context;

namespace Cratis.Chronicle.InProcess.Integration.for_Reactors.when_connecting.non_existent.with_single_partition;
...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_disconnected_reactor_observing_no_event_types(chronicleInProcessFixture)
    {
