...
using context = Cratis.Chronicle.InProcess.Integration.for_Reactors.when_appending_to_outbox.and_reactor_forwards_event_to_outbox.context;

namespace Cratis.Chronicle.InProcess.Integration.for_Reactors.when_appending_to_outbox;
