...
using Cratis.Monads;
using context = Cratis.Chronicle.Integration.Specifications.for_JobsManager.when_starting.job_with_single_step.and_job_step_completes_successfully.context;
