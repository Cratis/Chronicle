...
using context = Cratis.Chronicle.Kernel.Integration.Patches.for_RenameReactors.when_applying_down.context;

namespace Cratis.Chronicle.Kernel.Integration.Patches.for_RenameReactors;
