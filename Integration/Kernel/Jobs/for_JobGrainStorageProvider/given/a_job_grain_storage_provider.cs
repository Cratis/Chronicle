...
namespace Cratis.Chronicle.Kernel.Integration.Jobs.for_JobGrainStorageProvider.given;

public class a_job_grain_storage_provider(ChronicleFixture fixture) : Specification<ChronicleFixture>(fixture)
{
