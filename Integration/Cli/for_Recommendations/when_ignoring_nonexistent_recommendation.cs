...
using context = Cratis.Chronicle.Integration.Cli.for_Recommendations.when_ignoring_nonexistent_recommendation.context;

namespace Cratis.Chronicle.Integration.Cli.for_Recommendations;

[Collection(ChronicleCollection.Name)]
public class when_ignoring_nonexistent_recommendation(context context) : CliGiven<context>(context)
{
    public class context : given.a_connected_cli
    {
        public CliCommandResult Result = null!;

        async Task Because() => Result = await RunCliAsync("recommendations", "ignore", "00000000-0000-0000-0000-000000000099", "--event-store", "system");
    }
