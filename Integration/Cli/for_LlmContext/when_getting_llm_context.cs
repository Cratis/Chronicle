...
using context = Cratis.Chronicle.Integration.Cli.for_LlmContext.when_getting_llm_context.context;

namespace Cratis.Chronicle.Integration.Cli.for_LlmContext;
