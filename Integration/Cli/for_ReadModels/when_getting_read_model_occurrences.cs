...
using context = Cratis.Chronicle.Integration.Cli.for_ReadModels.when_getting_read_model_occurrences.context;
    ...
    public class context : given.a_connected_cli
    {
        ...
        async Task Because()
        {
            ...
            if (HasReadModels)
            {
                ...
                OccurrencesResult = await RunCliAsync("read-models", "occurrences", typeIdentifier, "--event-store", "system");
            }
        }
    }
