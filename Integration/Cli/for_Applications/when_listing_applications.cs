...
using context = Cratis.Chronicle.Integration.Cli.for_Applications.when_listing_applications.context;
...
public class when_listing_applications(context context) : CliGiven<context>(context)
{
    public class context : given.a_connected_cli
    {
        ...
        async Task Because() => Result = await RunCliAsync("applications", "list");
    }
