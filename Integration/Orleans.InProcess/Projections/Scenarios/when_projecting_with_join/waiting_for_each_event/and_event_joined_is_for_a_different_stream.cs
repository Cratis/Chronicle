...
using context = Cratis.Chronicle.Integration.Orleans.InProcess.Projections.Scenarios.when_projecting_with_join.waiting_for_each_event.and_event_joined_is_for_a_different_stream.context;
...
public class and_event_joined_is_for_a_different_stream(context context) : Given<context>(context)
{
    ...
    public class context(ChronicleMongoDBFixture chronicleMongoDbFixture) : given.a_projection_and_events_appended_to_it<ProjectionWithJoinOnRoot, User>(chronicleMongoDbFixture)
    {
