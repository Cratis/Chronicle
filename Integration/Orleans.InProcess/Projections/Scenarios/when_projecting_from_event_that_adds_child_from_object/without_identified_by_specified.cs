...
{
    public class context(GlobalFixture globalFixture) : given.a_projection_and_events_appended_to_it<UnidentifiableChildrenProjection, ModelWithChildren>(globalFixture)
    {
