...
{
    public class context(ChronicleMongoDBFixture chronicleMongoDbFixture) : given.a_projection_and_events_appended_to_it<SetValuesProjection, Model>(chronicleMongoDbFixture)
    {
