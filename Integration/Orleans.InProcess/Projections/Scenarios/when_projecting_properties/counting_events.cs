...
{
    public class context(ChronicleInProcessFixture chronicleInProcessFixture) : given.a_projection_and_events_appended_to_it<CountingEventsProjection, Model>(chronicleInProcessFixture)
    {
