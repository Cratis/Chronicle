...
{
    public class context(ChronicleFixture ChronicleFixture) : given.a_projection_and_events_appended_to_it<SubtractingFromPropertiesProjection, Model>(ChronicleFixture)
    {
