...
public class a_projection_and_events_appended_to_it<TProjection, TModel>(ChronicleMongoDBFixture chronicleMongoDbFixture) : IntegrationSpecificationContext(chronicleMongoDbFixture)
...
#pragma warning restore CA2213 // Disposable fields should be disposed
    ...
    protected async Task<TModel> GetModel(EventSourceId eventSourceId)
    {
        ...
        var result = await ChronicleMongoDbFixture.ReadModels.Database.GetCollection<TModel>().FindAsync(filter);
