...
namespace Cratis.Chronicle.Integration.Orleans.InProcess.for_Reactors.when_connecting.existing.with_single_partition.failing;

[Collection(GlobalCollection.Name)]
public class and_is_not_behind(context context) : Given<context>(context)
{
