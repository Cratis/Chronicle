...
public class a_reactor_observing_an_event_that_can_fail(ChronicleMongoDBFixture chronicleMongoDbFixture, int numberOfObservations) : IntegrationSpecificationContext(chronicleMongoDbFixture)
{
