...
public class a_reducer_observing_an_event_that_can_fail(ChronicleMongoDBFixture chronicleMongoDbFixture, int numberOfObservations) : IntegrationSpecificationContext(chronicleMongoDbFixture)
{
