...
using context = Cratis.Chronicle.Integration.Orleans.InProcess.for_Reducers.when_connecting.non_existent.with_single_partition.and_reducer_is_registered_while_there_are_events_in_sequence.context;
...
{
    public class context(ChronicleMongoDBFixture chronicleMongoDbFixture) : given.a_disconnected_reducer_observing_an_event(chronicleMongoDbFixture)
    {
