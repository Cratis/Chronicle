...
If you use Cratis Arc with the Chronicle extension, tenancy is automatically configured for namespaces. See [Arc Chronicle tenancy](/arc/backend/chronicle/tenancy/) for details.
