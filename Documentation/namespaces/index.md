...
If you use Cratis Arc with the Chronicle extension, tenancy is automatically configured for namespaces. See [Arc Tenancy](xref:Arc.Chronicle.Tenancy) for details.
