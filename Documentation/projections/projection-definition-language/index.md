...
The Projection Definition Language (PDL) is a modern, indentation-based DSL for defining Chronicle projections without writing code. It provides an elegant, compact syntax that reads as rules applied to events and compiles into the existing Chronicle projection model with zero loss of functionality.
...
Start with simple projections and gradually add complexity as needed. The DSL is designed to be intuitive and readable, making it easy to understand what a projection does at a glance.
