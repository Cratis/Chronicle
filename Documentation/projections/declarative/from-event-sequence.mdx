---
title: "Projection with FromEventSequence"
description: "Build a declarative projection from an event sequence other than the event log."
---
...
- Only matching events in the event log are processed; events in other event sequences are not
