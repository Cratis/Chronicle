...
<ChronicleClientTabs snippet="contributing/clients/typescript-grpc-package/event-stores-definition" variants="typescript" />

The package also includes generated request and response message helpers:

<ChronicleClientTabs snippet="contributing/clients/typescript-grpc-package/request-messages" variants="typescript" />

### Service Definitions

Service definitions expose the protobuf service name and generated method definitions:

<ChronicleClientTabs snippet="contributing/clients/typescript-grpc-package/namespaces-definition" variants="typescript" />

### Typed Clients

When a gRPC transport creates clients from the generated definitions, use the generated client interfaces for type safety:

<ChronicleClientTabs snippet="contributing/clients/typescript-grpc-package/service-types" variants="typescript" />
