...
description: Chronicle's kernel, protocol, event-store, namespace, and persistent-subscription boundaries.
---
...
<CardGrid>
  <SimpleCard title="Chronicle overview" icon="seti:db" link="/chronicle/">
    Start Chronicle locally and understand what the runtime owns.
  </SimpleCard>
  <SimpleCard title="Workbench" icon="laptop" link="/chronicle/workbench/">
    Inspect the running Chronicle instance from a local browser.
  </SimpleCard>
