...
title: "Erasing a subject"
description: "Erase a person's data with one call, what it reaches, and what you still have to do yourself."
---
...
The mechanics of the fence, and what it cannot protect you against, are in [The encryption key lifecycle](key-lifecycle).
