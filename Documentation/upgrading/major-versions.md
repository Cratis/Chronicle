...
### 6 → 7 (2023-01-10) — stored observer state
...
### 7 → 8 (2023-01-23) — namespaces, transport and several APIs
...
### 8 → 9 (2023-07-19) — repository split and startup
...
### 9 → 10 (2024-07-30) — no recorded change
...
### 10 → 11 (2025-03-12) — stored job state
...
### 11 → 12 (2025-06-04) — internalized APIs and a renamed package
...
### 12 → 13 (2025-06-23) — one method became async
...
### 13 → 14 (2025-08-15) — read-model formalization and stored layout
...
### 14 → 15 (2026-02-03) — Rules retired, TLS, content type
...
### 15 → 16 (2026-07-09) — one port, always TLS
...
### 16 → 17 (2026-08-25) — the generated wire contract
...
### 17 → 18 (2026-09-08) — append content back to a string
...
### 18 → 19 (2026-09-17) — a .NET signature
...
- **Compile-time changes accumulate but do not interact.** Renamed namespaces, moved types and
  changed signatures simply pile up; you fix them once against the version you land on.
