...
// Error CHR0038: The join with 'Chr0038AdvisorNamed' on 'AdvisorName' copies the [PII]
// value 'Chr0038AdvisorNamed.DisplayName' through 'AdvisorId', which differs from this
// read model's apparent compliance subject.
