...
- **Wire Chronicle into an existing app** — [run the kernel](./running-chronicle.md), then follow the host guide for [ASP.NET Core](./aspnetcore.md), a [Worker Service](./worker.md), or a bare [Console](./console.md).
