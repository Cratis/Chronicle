...
The template's `Program.cs` is about twenty lines, and it contains a complete Chronicle loop. Here's the heart of it:
...
- **Wire Chronicle into an existing app** — the same setup for [ASP.NET Core](./aspnetcore.md), a [Worker Service](./worker.md), or a bare [Console](./console.md) host.
