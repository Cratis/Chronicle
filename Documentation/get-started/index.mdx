...
- **Wire Chronicle into an existing app** — [choose a hosting model](./choose-hosting-model.md), [run the kernel](./running-chronicle.md), then follow the guide for [ASP.NET Core](./aspnetcore.md), a [Worker Service](./worker.md), or a bare [Console](./console.md).
