---
title: Reactors
description: React to appended events with side effects, external integrations, and follow-up actions.
---
...
> Reactors react to **events**. To react instead to a **read model** being added, modified or removed — with the same convention-based methods, dependencies and side effects — see [Reacting to Read Model Changes](../read-models/reacting-to-changes).
