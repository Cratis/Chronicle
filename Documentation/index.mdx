---
title: Chronicle
description: The event sourcing platform with a gRPC boundary, first-class .NET client, TypeScript, Elixir, and Kotlin clients/contracts, storage backends for MongoDB/PostgreSQL/SQL Server/SQLite, and rich tooling.
---
...
<CardGrid>
  <SimpleCard title="gRPC at the boundary" icon="puzzle" link="/chronicle/architecture/">
    Chronicle is a client-server kernel with gRPC/protobuf contracts. The .NET client is first-class and most mature; TypeScript and Elixir clients/contracts and a gRPC-level Kotlin client are generated from the same protocol.
  </SimpleCard>
