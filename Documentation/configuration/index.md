...
This section covers application and client configuration for Chronicle SDKs. For server configuration, see [Hosting Configuration](../hosting/configuration/index.md).
