...
`CHR0038` refuses an explicit different-subject boundary reached through a `[Join]`. [CHR0044](CHR0044) warns when a join's runtime-subject equality is unprovable. This rule covers the key-redirection route.
