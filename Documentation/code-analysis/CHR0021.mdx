...
<ChronicleClientTabs snippet="code-analysis/chr0021/violation" variants="csharp" />

### Fix

<ChronicleClientTabs snippet="code-analysis/chr0021/fix" variants="csharp" />

Or with init-only property syntax for events with many properties:

<ChronicleClientTabs snippet="code-analysis/chr0021/fix-init" variants="csharp" />
