...
<ChronicleClientTabs snippet="code-analysis/chr0041/violation" variants="csharp" />
...
- [CHR0045: Event stream metadata attribute on an event type has no effect](CHR0045) — the same attributes on the other placement that reads as stream identity and is not one.
