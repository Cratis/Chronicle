...
- Reactors: [Subscribe Reactors to External Event Stores](../reactors/external-event-store-subscriptions)
- Reducers: [Subscribe Reducers to External Event Stores](../reducers/external-event-store-subscriptions)
...
**Use [explicit subscriptions](explicit-subscriptions) when:**
