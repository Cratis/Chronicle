...
Auto-mapping works when property names and types match between the event and read model. For more control over the mapping, see [projection with custom properties](./projection-with-properties.md).
