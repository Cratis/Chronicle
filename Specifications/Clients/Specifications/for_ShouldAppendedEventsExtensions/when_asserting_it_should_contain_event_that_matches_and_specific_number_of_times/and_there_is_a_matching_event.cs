...
namespace Cratis.Specifications.when_asserting_it_should_contain_event_that_matches_and_specific_number_of_times;
...
public class and_there_is_a_matching_event : given.no_events
{
    ...
    void Because() => result = Catch.Exception(() => events.ShouldContainEvent<MyEvent>(ev => ev.SomeInteger == 43, Exactly(2)));
