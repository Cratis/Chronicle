...
namespace Cratis.Specifications.when_asserting_it_should_not_contain_event_that_matches;
...
public class and_there_are_no_matching_event : given.no_events
{
    ...
    void Because() => result = Catch.Exception(() => events.ShouldNotContainEvent<MyEvent>(ev => ev.SomeInteger == 42));
