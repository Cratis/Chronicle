...
public class when_providing_type_with_constructor_taking_provider_for_collection_of_specific_read_model : Specification
{
    record ReadModel();
    class TypeWithDependencies
    {
        public TypeWithDependencies(ProviderFor<IMongoCollection<ReadModel>> provider) { }
    }
