...
namespace Cratis.Events.for_EventTypeExtensions.when_getting_event_types_for_type;
...
public class and_type_it_an_interface_but_has_derivatives_that_are : Specification
{
    ...
    void Because() => result = typeof(IMyEvent).GetEventTypes(new[] { typeof(FirstDerivative), typeof(SecondDerivative) });
