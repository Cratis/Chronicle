...
public class when_filtering_on_model_properties_are_set_and_they_are_not : given.a_change_on_one_property
{
    ...
    [Fact] void should_not_filter_through_the_context() => result.ShouldBeNull();
}
