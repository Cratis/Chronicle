...
public class when_filtering_on_properties_becoming_null_and_next_value_matches_one_property : given.a_change_on_one_property_that_becomes_null
{
    ImportContext<Model, ExternalModel> result;

    void Establish()
    {
        context = import_builder.WithPropertiesBecomingNull(_ => _.SomeString);
