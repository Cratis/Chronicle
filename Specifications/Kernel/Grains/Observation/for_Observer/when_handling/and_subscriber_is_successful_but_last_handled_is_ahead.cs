...
public class and_subscriber_is_successful_but_last_handled_is_ahead : given.an_observer_with_subscription_for_specific_event_type
{
    void Establish()
    {
        ...
        observer_state_storage.State = observer_state_storage.State with { LastHandledEventSequenceNumber = 44UL };
    }
    ...
    [Fact] void should_not_modify_last_handled_event_sequence_number() => observer_state_storage.State.LastHandledEventSequenceNumber.ShouldEqual((EventSequenceNumber)44UL);
}
