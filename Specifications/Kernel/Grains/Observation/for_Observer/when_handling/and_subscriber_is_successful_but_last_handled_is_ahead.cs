...
public class and_subscriber_is_successful_but_last_handled_is_ahead : given.an_observer_with_subscription
{
    void Establish()
    {
    ...
    [Fact] void should_not_modify_last_handled_event_sequence_number() => written_states[0].LastHandled.ShouldEqual((EventSequenceNumber)44UL);
}
