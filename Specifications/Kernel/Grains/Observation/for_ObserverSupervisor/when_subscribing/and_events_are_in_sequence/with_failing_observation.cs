...
public class with_failing_observation : given.an_observer_and_two_event_types_and_one_event_in_sequence
{
    ...
    [Fact] void should_register_reminder() => reminder_registry.Verify(_ => _.RegisterOrUpdateReminder(ObserverSupervisor.RecoverReminder, IsAny<TimeSpan>(), IsAny<TimeSpan>()), Once());
}
