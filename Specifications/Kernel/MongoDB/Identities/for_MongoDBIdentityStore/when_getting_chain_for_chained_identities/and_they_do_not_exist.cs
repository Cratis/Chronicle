...
namespace Aksio.Cratis.Kernel.MongoDB.Identities.for_MongoDBIdentityStore.when_getting_chain_for_chained_identities;
...
public class and_they_do_not_exist : given.no_identities_registered
{
    ...
    [Fact] void should_insert_the_top_level_identity_with_the_correct_subject() => inserted_identities.First().Subject.ShouldEqual(top_level_identity.Subject);
    [Fact] void should_insert_the_top_level_identity_with_the_correct_name() => inserted_identities.First().Name.ShouldEqual(top_level_identity.Name);
    [Fact] void should_insert_the_top_level_identity_with_the_correct_user_name() => inserted_identities.First().UserName.ShouldEqual(top_level_identity.UserName);
