...
namespace Aksio.Cratis.Kernel.Engines.Projections.Expressions.ModelProperties.for_SetExpressionResolver;
...
public class when_trying_to_resolve_valid_set_expression_against_model_and_event : given.an_appended_event
{
    ...
    void Because() => resolver.Resolve("targetProperty", new(), nameof(MyEvent.Something).ToCamelCase())(@event, target, ArrayIndexers.NoIndexers);
