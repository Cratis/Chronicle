...
using Aksio.Cratis.Kernel.Engines.Projections.Scenarios.Projections;
using Aksio.Cratis.Specifications.Integration;

namespace Aksio.Cratis.Kernel.Engines.Projections.Scenarios.when_projecting_properties;

public class adding_from_properties : ProjectionSpecificationFor<Model>
{
    ...
    protected override IProjectionFor<Model> CreateProjection() => new AddingFromPropertiesProjection();
