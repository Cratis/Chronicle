...
namespace Aksio.Cratis.Events.Projections.for_ProjectionExtensions.when_applying_from_filter
{
    public class when_handling_child : given.an_observable_and_event_setup
    {
        ...
        [Fact] void should_add_child_to_changeset() => changeset.Verify(_ => _.AddChild(children_property, identified_by_property, key, property_mappers, ArrayIndexers.NoIndexers), Once());
    }
}
