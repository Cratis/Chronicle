...
namespace Aksio.Cratis.Kernel.Projections.for_ProjectionManager;
...
public class when_registering : given.a_projection_manager_without_any_projections
{
    ...
    [Fact] void should_create_pipeline() => projection_pipeline_factory.Verify(_ => _.CreateFrom(IsAny<IProjection>(), pipeline_definition), Once);
}
