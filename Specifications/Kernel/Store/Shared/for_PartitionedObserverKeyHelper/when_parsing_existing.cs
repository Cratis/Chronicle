...
namespace Aksio.Cratis.Events.Store.Observation.for_PartitionedObserverKey;
...
public class when_parsing_existing : Specification
{
    ...
    const string combined = $"{microservice_id}+{tenant_id}+{event_sequence_id}+{event_source_id}";
