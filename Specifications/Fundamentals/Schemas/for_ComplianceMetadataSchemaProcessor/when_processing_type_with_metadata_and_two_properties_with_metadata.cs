...
namespace Cratis.Schemas.for_ComplianceMetadataSchemaProcessor
{
    public class when_processing_type_with_metadata_and_two_properties_with_metadata : given.a_processor_and_a_context_for<TypeWithProperties>
    {
        ...
        ComplianceMetadataSchemaProcessor.Metadata[] GetMetadata() => ((IEnumerable<ComplianceMetadataSchemaProcessor.Metadata>)context.Schema.ExtensionData[JsonSchemaGenerator.ComplianceKey]).ToArray();
        ComplianceMetadataSchemaProcessor.Metadata[] GetMetadataForProperty(string property)
        {
            ...
            return ((IEnumerable<ComplianceMetadataSchemaProcessor.Metadata>)propertySchema.ExtensionData[JsonSchemaGenerator.ComplianceKey]).ToArray();
        }
    }
}
