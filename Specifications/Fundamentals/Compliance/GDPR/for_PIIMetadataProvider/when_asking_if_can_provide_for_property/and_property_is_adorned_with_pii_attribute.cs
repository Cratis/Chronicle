...
namespace Aksio.Cratis.Kernel.Engines.Compliance.GDPR.for_PIIMetadataProvider.when_asking_if_can_provide_for_property;

public class and_property_is_adorned_with_pii_attribute : given.a_provider
{
    class MyClass
    {
        [PII]
