...
namespace Aksio.Cratis.Dynamic.for_ExpandoObjectExtensions
{
    public class when_overwriting_object_with_other : Specification
    {
        ...
        [Fact] void should_create_a_new_object_for_nested_object() => ((int)result_as_dynamic.Nested.GetHashCode() != (int)left_as_dynamic.Nested.GetHashCode() &&
        ...
        [Fact] void should_create_a_new_object_for_partial_nested_object() => ((int)result_as_dynamic.PartialNested.GetHashCode() != (int)left_as_dynamic.PartialNested.GetHashCode() &&
