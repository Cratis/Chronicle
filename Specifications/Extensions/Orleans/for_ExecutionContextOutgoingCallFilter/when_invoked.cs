...
namespace Aksio.Cratis.Extensions.Orleans.Execution.for_ExecutionContextOutgoingCallFilter;
...
public class when_invoked : Specification
{
    ...
    [Fact] void should_set_microservice_id() => request_context_manager.Verify(_ => _.Set(RequestContextKeys.MicroserviceId, microservice_id.ToString()), Once());
