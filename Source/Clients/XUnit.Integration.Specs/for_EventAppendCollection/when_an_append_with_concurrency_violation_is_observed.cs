...
public class when_an_append_with_concurrency_violation_is_observed : given.an_event_append_collection
{
    ...
    [Fact] void should_have_the_correct_concurrency_violation() => _collected.Result.ConcurrencyViolation.ShouldEqual(_violation);
    [Fact] void should_have_concurrency_violations() => _collected.Result.HasConcurrencyViolations.ShouldBeTrue();
