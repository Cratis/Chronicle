...
public class and_method_invokes_execute_with_once_only : given.a_reactor_command_pipeline_execute_analyzer
{
    const string Usage = """
    ...
    void Because() => _result = AnalyzerVerifier<CodeAnalysis.Analyzers.ReactorCommandPipelineExecuteOnceOnlyAnalyzer>.VerifyAnalyzer(CreateSource(Usage));
