...
public class and_all_event_types_have_same_event_store_from_assembly_attribute : given.a_reactor_multiple_event_stores_analyzer
{
    ...
    void Because() => _result = AnalyzerVerifier<CodeAnalysis.Analyzers.ReactorMultipleEventStoresAnalyzer>.VerifyAnalyzer(CreateSource(Usage, AssemblyAttributes));
