...
/// <summary>
/// An assertion that hands back a value discards its exception exactly like the non-generic shape does.
/// </summary>
public class and_it_returns_a_generic_task : given.a_non_awaited_assertion_analyzer
{
    const string Usage = """
    public class Spec
    {
        ...
        void should_have_appended_events()
        {
            {|#0:_eventLog.ShouldHaveAppendedEvents()|};
        }
    }
    """;
