...
/// <summary>
/// A ValueTask carries the assertion exception the same way a Task does, and dropping it is just as silent.
/// </summary>
public class and_it_returns_a_value_task : given.a_non_awaited_assertion_analyzer
{
    const string Usage = """
    public class Spec
    {
        ...
        {
            {|#0:_eventLog.ShouldHaveNoEvents()|};
        }
    }
    """;
