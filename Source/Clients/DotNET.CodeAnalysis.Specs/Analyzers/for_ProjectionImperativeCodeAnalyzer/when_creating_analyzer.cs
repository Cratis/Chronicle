...
public class when_creating_analyzer : Specification
{
    ...
    [Fact] void should_support_chr0017_diagnostic() => _analyzer.SupportedDiagnostics.Any(d => d.Id == DiagnosticIds.ProjectionDefineMustNotContainImperativeCode).ShouldBeTrue();
}
