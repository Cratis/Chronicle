...
namespace Cratis.Chronicle.CodeAnalysis.Specs.Analyzers.for_KeyRedirectionPiiAnalyzer;

public class when_creating_analyzer : Specification
{
    CodeAnalysis.Analyzers.KeyRedirectionPiiAnalyzer _analyzer;

    void Establish() => _analyzer = new CodeAnalysis.Analyzers.KeyRedirectionPiiAnalyzer();
