...
public class and_method_returns_enumerable_of_events_without_once_only : given.a_reactor_once_only_analyzer
{
    const string Usage = """
    ...
    {
        public {|#0:IEnumerable<ResultEvent> On(SomeEvent @event)|}
        {
            return new[] { new ResultEvent(), new ResultEvent() };
        }
    }
    """;
