...
public class and_expression_lambda_accesses_nested_members : given.a_projection_expression_lambda_analyzer
{
    const string Usage = """
    public class Owner { public string Name { get; set; } }
    public class AnEvent { public Owner Owner { get; set; } }
    public class ReadModel { public string CustomerName { get; set; } }
