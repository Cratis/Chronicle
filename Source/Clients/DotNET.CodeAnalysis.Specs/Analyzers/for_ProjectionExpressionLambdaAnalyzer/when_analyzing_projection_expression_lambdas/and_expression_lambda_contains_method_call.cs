...
public class and_expression_lambda_contains_method_call : given.a_projection_expression_lambda_analyzer
{
    const string Usage = """
    ...
    {
        public static string GetName(this AnEvent e) => e.Name;
    }
    """;
