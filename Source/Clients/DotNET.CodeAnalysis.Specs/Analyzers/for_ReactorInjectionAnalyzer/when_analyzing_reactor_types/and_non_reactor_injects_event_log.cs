...
public class and_non_reactor_injects_event_log : given.a_reactor_injection_analyzer
{
    const string Usage = """
    public class NotAReactor
    {
        public NotAReactor(Cratis.Chronicle.EventSequences.IEventLog eventLog) { }
    }
    """;
