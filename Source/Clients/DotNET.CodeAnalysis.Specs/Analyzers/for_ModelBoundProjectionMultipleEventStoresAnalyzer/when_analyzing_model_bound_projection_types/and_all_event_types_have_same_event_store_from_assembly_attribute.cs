...
public class and_all_event_types_have_same_event_store_from_assembly_attribute : given.a_model_bound_projection_multiple_event_stores_analyzer
{
    ...
    void Because() => _result = AnalyzerVerifier<CodeAnalysis.Analyzers.ModelBoundProjectionMultipleEventStoresAnalyzer>.VerifyAnalyzer(CreateSource(Usage, AssemblyAttributes));
