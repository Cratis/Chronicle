...
public class and_wrapped_events_have_named_concurrency_scopes : given.an_event_sequence_append_analyzer
{
    const string Usage = """
    public class Usage
    {
    ...
    [Fact] Task should_not_report_a_diagnostic_for_the_scopes() => _result;
}
