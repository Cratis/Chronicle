...
public class and_wrapped_events_have_named_tags : given.an_event_sequence_append_analyzer
{
    const string Usage = """
    public class Usage
    {
        public void Append()
        {
            ...
            sequence.AppendMany(events, tags: new System.Collections.Generic.List<string> { "category" });
        }
    }
    """;
    ...
    [Fact] Task should_not_report_a_diagnostic_for_the_tags() => _result;
}
