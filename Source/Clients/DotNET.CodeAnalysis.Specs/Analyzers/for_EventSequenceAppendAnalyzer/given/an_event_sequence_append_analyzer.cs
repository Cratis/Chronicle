...
public class an_event_sequence_append_analyzer : Specification
{
    protected static string CreateSource(string usage)
    {
        ...
        [
            ...
            "        void AppendMany(IEnumerable<EventForEventSourceId> events, CorrelationId correlationId = null, IEnumerable<string> tags = null, IDictionary<EventSourceId, ConcurrencyScope> concurrencyScopes = null);",
            "    }",
            "",
            ...
            "        {",
            "        }",
            "        public void AppendMany(IEnumerable<EventForEventSourceId> events, CorrelationId correlationId = null, IEnumerable<string> tags = null, IDictionary<EventSourceId, ConcurrencyScope> concurrencyScopes = null)",
            "        {",
            "        }",
            "    }",
