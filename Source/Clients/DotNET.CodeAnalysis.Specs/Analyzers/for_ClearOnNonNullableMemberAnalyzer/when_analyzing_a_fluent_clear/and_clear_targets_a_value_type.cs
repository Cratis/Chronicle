...
/// <summary>
/// A value type cannot hold null whatever the nullable context says.
/// </summary>
public class and_clear_targets_a_value_type : given.a_fluent_clear_on_non_nullable_member_analyzer
{
    const string Usage = """
    public record SliceCommandCleared();

    public record Slice(string Id, int Attempts);
