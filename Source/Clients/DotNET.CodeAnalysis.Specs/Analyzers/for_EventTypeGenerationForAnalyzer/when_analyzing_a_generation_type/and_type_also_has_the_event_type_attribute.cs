...
public class and_type_also_has_the_event_type_attribute : given.an_event_type_generation_for_analyzer
{
    const string Usage = """
    ...
    void Because() => _result = AnalyzerVerifier<CodeAnalysis.Analyzers.EventTypeGenerationForAnalyzer>.VerifyAnalyzer(
        CreateSource(Usage),
        new ExpectedDiagnostic(DiagnosticIds.EventTypeGenerationForCannotCombineWithEventType, DiagnosticSeverity.Error, "CustomerRegisteredV1"));
