...
public class and_referenced_type_is_itself_a_generation : given.an_event_type_generation_for_analyzer
{
    const string Usage = """
    [EventType("customer-registered", generation: 3)]
    public record CustomerRegisteredV3(string FirstName, string LastName);

    [EventTypeGenerationFor<CustomerRegisteredV3>(2)]
