...
public class and_callback_belongs_to_another_builder : given.a_redundant_auto_map_call_analyzer
{
    const string Usage = """
    ...
    public class MyProjection : Cratis.Chronicle.Projections.IProjectionFor<ReadModel>
    {
        ...
        public void Define(Cratis.Chronicle.Projections.IProjectionBuilderFor<ReadModel> builder) =>
            Other.Children(m => m.Children, child => child.AutoMap());
    }
    """;
    ...
    [Fact] Task should_not_report_the_unrelated_callback() => _result;
}
