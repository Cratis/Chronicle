...
public class and_helper_reenables_its_parameter : given.a_redundant_auto_map_call_analyzer
{
    const string Usage = """
    ...
    public class MyProjection : Cratis.Chronicle.Projections.IProjectionFor<ReadModel>
    {
        ...
        void Reenable(Cratis.Chronicle.Projections.IProjectionBuilderFor<ReadModel> builder) => builder.AutoMap();
    }
    """;
    ...
    [Fact] Task should_not_report_the_helper_call() => _result;
}
