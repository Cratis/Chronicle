...
public class and_base_model_disables_auto_map : given.a_redundant_auto_map_call_analyzer
{
    const string Usage = """
    [Cratis.Chronicle.Projections.NoAutoMap]
    public class BaseModel { public string Name { get; set; } }
    public class ReadModel : BaseModel { }
    public class MyProjection : Cratis.Chronicle.Projections.IProjectionFor<ReadModel>
    {
        public void Define(Cratis.Chronicle.Projections.IProjectionBuilderFor<ReadModel> builder) => builder.AutoMap();
    }
    """;
    ...
    [Fact] Task should_not_report_the_inherited_attribute() => _result;
}
