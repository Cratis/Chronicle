...
/// <summary>
/// With AutoMap off nothing carries the identically named value across, so no PII reaches the read model.
/// </summary>
public class and_automap_is_turned_off : given.a_fluent_key_redirection_pii_analyzer
{
    const string Usage = """
