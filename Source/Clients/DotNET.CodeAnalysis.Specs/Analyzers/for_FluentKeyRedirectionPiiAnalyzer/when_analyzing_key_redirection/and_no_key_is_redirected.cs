...
/// <summary>
/// Without a redirection the document is keyed by the stream the event was appended to, which is where the PII already belongs.
/// </summary>
public class and_no_key_is_redirected : given.a_fluent_key_redirection_pii_analyzer
{
    const string Usage = """
