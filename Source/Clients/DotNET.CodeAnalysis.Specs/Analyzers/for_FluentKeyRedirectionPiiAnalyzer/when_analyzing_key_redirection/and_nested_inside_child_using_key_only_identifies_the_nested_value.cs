...
public class and_nested_inside_child_using_key_only_identifies_the_nested_value : given.a_fluent_key_redirection_pii_analyzer
{
    const string Usage = """
    public record ContactDetailsChanged(string ContactId, [PII] string EmailAddress);
