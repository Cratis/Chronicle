...
namespace Cratis.Chronicle.CodeAnalysis.Specs.Analyzers.for_FluentCrossSubjectPiiJoinAnalyzer;

public class when_creating_analyzer : Specification
{
    CodeAnalysis.Analyzers.FluentCrossSubjectPiiJoinAnalyzer _analyzer;

    void Establish() => _analyzer = new CodeAnalysis.Analyzers.FluentCrossSubjectPiiJoinAnalyzer();
