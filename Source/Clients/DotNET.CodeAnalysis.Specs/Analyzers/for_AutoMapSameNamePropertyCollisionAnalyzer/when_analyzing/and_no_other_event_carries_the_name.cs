...
public class and_no_other_event_carries_the_name : given.an_auto_map_same_name_property_collision_analyzer
{
    const string Usage = """
    public record Opened(Guid Id, string Name);
    public record Noted(Guid Id, string Description);
