...
namespace Cratis.Chronicle.CodeAnalysis.Specs.Analyzers.for_PassiveProjectionKeyRedirectionAnalyzer;

public class when_creating_analyzer : Specification
{
    CodeAnalysis.Analyzers.PassiveProjectionKeyRedirectionAnalyzer _analyzer;

    void Establish() => _analyzer = new CodeAnalysis.Analyzers.PassiveProjectionKeyRedirectionAnalyzer();
