...
/// <summary>
/// Without a key the document is the event source id, which is exactly what the replay walks.
/// </summary>
public class and_no_key_is_redirected : given.a_passive_projection_key_redirection_analyzer
{
    const string Usage = """
    public record UserSignedUp(string Hash, string Region);

    [Passive]
    [FromEvent<UserSignedUp>]
