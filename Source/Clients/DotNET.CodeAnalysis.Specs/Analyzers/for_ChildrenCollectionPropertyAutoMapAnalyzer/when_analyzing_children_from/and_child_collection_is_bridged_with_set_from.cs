...
public class and_child_collection_is_bridged_with_set_from : given.a_children_collection_property_auto_map_analyzer
{
    const string Usage = """
    ...
    public record Line(
        ...
        string Description,
        [SetFrom<LineAdded>(nameof(LineAdded.Annotations))] IReadOnlyList<Note> Notes);
