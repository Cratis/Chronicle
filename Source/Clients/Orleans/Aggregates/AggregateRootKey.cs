...
/// </summary>
/// <param name="EventSourceType">The <see cref="EventSourceType"/> part of the key.</param>
...
public record AggregateRootKey(EventSourceType EventSourceType, EventSourceId EventSourceId, EventStreamId EventStreamId)
{
    /// <summary>
    ...
    /// <inheritdoc/>
    public override string ToString() => KeyHelper.Combine(EventSourceType, EventSourceId, EventStreamId);
