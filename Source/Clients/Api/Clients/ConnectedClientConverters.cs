...
internal static class ConnectedClientConverters
{
    ...
    public static ConnectedClient ToApi(this Contracts.Clients.ConnectedClient client) =>
        new(client.SiloAddress, client.ConnectionId, client.Version, client.LastSeen, client.IsRunningWithDebugger, client.ProcessId, client.ProcessPath, client.MachineName);
