...
[Command]
public record GenerateDeclarativeCode(string EventStore, string Namespace, string Declaration, DraftReadModel? DraftReadModel = null, string Language = nameof(ProjectionCodeLanguage.CSharp))
{
    /// <summary>
