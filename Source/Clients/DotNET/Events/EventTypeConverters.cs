...
public static class EventTypeConverters
{
    ...
    public static EventType ToClient(this Kernel.Contracts.Events.EventType eventType) =>
    ...
    /// <returns>Converted collection of contract version.</returns>
    public static IEnumerable<EventType> ToClient(this IEnumerable<Kernel.Contracts.Events.EventType> types) =>
