...
public static class EventTypeConverters
{
    ...
    public static EventType ToClient(this Chronicle.Contracts.Events.EventType eventType) =>
    ...
    /// <returns>Converted collection of contract version.</returns>
    public static IEnumerable<EventType> ToClient(this IEnumerable<Chronicle.Contracts.Events.EventType> types) =>
