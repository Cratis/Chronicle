...
namespace Cratis.Events.Projections
{
    ...
    public record ChildrenDefinition(string IdentifiedBy, ModelDefinition Model, IDictionary<string, FromDefinition> From, RemovedWithDefinition? RemovedWith = default);
}
