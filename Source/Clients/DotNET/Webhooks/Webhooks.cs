...
public class Webhooks : IWebhooks
{
    ...
    readonly ILogger<Webhooks> _logger;
    ...
    /// <param name="reducerDefinitionValidator"><see cref="IReducerValidator"/> for validating reducer types.</param>
        ...
        _handlersByType = _clientArtifacts.Reducers
                            .ToDictionary(
                                ...
                                reducerType =>
                                {
                                    ...
                                    _reducerDefinitionValidator.Validate(reducerType);
