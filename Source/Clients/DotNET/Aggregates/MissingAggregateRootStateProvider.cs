...
public class MissingAggregateRootStateProvider(Type type) : Exception($"Missing aggregate root state provider for {type.FullName}. You should either implement a reducer or an projection for the state for this type")
{
}
