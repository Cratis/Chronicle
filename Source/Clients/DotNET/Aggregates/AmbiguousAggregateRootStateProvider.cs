...
public class AmbiguousAggregateRootStateProvider(Type type) : Exception($"Ambiguous aggregate root state provider for {type.FullName}. You should either implement a reducer or an projection for the state for this type, not both")
{
}
