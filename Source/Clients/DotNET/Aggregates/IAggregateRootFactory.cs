...
public interface IAggregateRootFactory
{
    ...
    /// <param name="eventSource">Optional <see cref="EventSourceType"/> for the context. Will default to <see cref="EventSourceType.Default"/>.</param>
    ...
    /// </remarks>
    Task<TAggregateRoot> Get<TAggregateRoot>(EventSourceId id, EventStreamId? streamId = default, EventSourceType? eventSource = default)
