...
public interface IAggregateRootFactory
{
    ...
    /// <param name="eventSource">Optional <see cref="EventSource"/> for the context. Will default to <see cref="EventSource.Default"/>.</param>
    ...
    /// </remarks>
    Task<TAggregateRoot> Get<TAggregateRoot>(EventSourceId id, EventStreamId? streamId = default, EventSource? eventSource = default)
