...
internal static partial class ReducersRegistrarLogMessages
{
    ...
    internal static partial void RegisterReducer(this ILogger<ReducersRegistrar> logger, ReducerId reducerId, ReducerName reducerName, EventSequenceId eventSequenceId);
}
