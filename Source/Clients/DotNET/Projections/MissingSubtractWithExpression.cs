...
public class MissingSubtractWithExpression(Type readModelType, PropertyPath propertyPath)
    : Exception($"Property '{propertyPath}' on '{readModelType.FullName}' is missing a `.With())` expression when subtracting.");
