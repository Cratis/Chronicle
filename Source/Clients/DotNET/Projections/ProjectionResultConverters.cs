...
public static class ProjectionResultConverters
{
    ...
    public static ProjectionResult<TModel> ToClient<TModel>(this Contracts.Projections.ProjectionResult result) =>
        new(
    ...
    /// <returns>Converted <see cref="ProjectionResult"/>.</returns>
    public static ProjectionResult ToClient(this Contracts.Projections.ProjectionResult result, Type modelType) =>
        new(
    ...
    /// <param name="result"><see cref="Contracts.Projections.ProjectionResult"/> to convert from.</param>
    /// <returns>Converted <see cref="ProjectionResult"/>.</returns>
    public static ProjectionResultRaw ToClient(this Contracts.Projections.ProjectionResult result) =>
        new(
