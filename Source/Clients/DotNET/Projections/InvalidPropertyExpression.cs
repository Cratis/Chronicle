...
/// <summary>
/// The exception that is thrown when a projection builder accessor is not a supported member-access value expression.
/// </summary>
/// <remarks>
...
public class InvalidPropertyExpression(string target, Expression expression)
    : Exception($"The expression `{expression}` used for {target} is not a supported value expression. " +
