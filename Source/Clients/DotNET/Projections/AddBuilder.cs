...
public class AddBuilder<TReadModel, TEvent, TProperty, TParentBuilder>(TParentBuilder parent, PropertyPath targetProperty, INamingPolicy namingPolicy) : IAddBuilder<TReadModel, TEvent, TProperty, TParentBuilder>
