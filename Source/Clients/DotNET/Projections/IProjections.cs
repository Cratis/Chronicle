...
public interface IProjections
{
    ...
    Task<ProjectionResult> GetInstanceById(Type modelType, ReadModelKey modelKey);
    ...
    Task<ProjectionResultRaw> GetInstanceById(ProjectionId identifier, ReadModelKey modelKey);
    ...
    /// <returns>The result of the projection in the form of an <see cref="ProjectionResult"/>.</returns>
    Task<ProjectionResult<TModel>> GetInstanceById<TModel>(ReadModelKey modelKey);
    ...
    /// <param name="modelKey"><see cref="ReadModelKey"/> to get instance for.</param>
    /// <returns>The result of the projection in the form of an <see cref="ProjectionResult"/>.</returns>
    Task<ProjectionResult> GetInstanceByIdForSession(ProjectionSessionId sessionId, Type modelType, ReadModelKey modelKey);
    ...
    /// <returns>The result of the projection in the form of an <see cref="ProjectionResult"/>.</returns>
    Task<ProjectionResult> GetInstanceByIdForSessionWithEventsApplied(ProjectionSessionId sessionId, Type modelType, ReadModelKey modelKey, IEnumerable<object> events);
    ...
    Task DehydrateSession(ProjectionSessionId sessionId, Type modelType, ReadModelKey modelKey);
