...
/// <summary>
/// Defines a system for working with <see cref="IReactionMiddleware">middlewares</see> that can be called during the observing of events.
/// </summary>
public interface IReactionMiddlewares
{
    /// <summary>
