...
public class without_concurrency_flag : given.an_events_command_response_value_handler
{
    ...
    void Establish()
    {
        _events = [new TestEvent("Event without concurrency")];
    ...
    [Fact] void should_append_without_concurrency_scope() => _eventLog.Received().AppendMany(
