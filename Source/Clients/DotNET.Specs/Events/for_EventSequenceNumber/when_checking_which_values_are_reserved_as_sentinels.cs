...
/// <summary>
/// <para>
/// <c language="csharp">First</c>, <c language="csharp">Unavailable</c> and <c language="csharp">Max</c> are wire values. The kernel has its own copy of
/// <see cref="EventSequenceNumber"/> and the two are compared across the wire - <c language="csharp">ConcurrencyScope.NotSet</c> is
/// built from <c language="csharp">Max</c> on both sides - so the numbers pinned here have to be the same numbers the kernel's copy
/// pins.
/// </para>
/// <para>
