...
/// scope carrying <c>BeforeFirst</c> is validated by the kernel as "no event matching this scope may exist" - so the
/// numbers pinned here have to be the same numbers the kernel's copy pins.
/// </summary>
