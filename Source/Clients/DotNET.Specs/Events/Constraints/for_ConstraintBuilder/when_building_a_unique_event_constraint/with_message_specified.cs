...
public class with_message_specified : given.a_constraint_builder_with_owner
{
    ...
    void Establish()
    {
        _violation = new ConstraintViolation(_eventTypeId, EventSequenceNumber.First, ConstraintType.UniqueEventType, "Some Constraint", "Error", []);
    ...
    void Because()
    {
        _constraintBuilder.Unique<SomeEvent>(message: Message);
