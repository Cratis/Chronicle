...
public class with_message_factory : given.a_unique_constraint_builder_with_owner_and_an_event_type
{
    ...
    void Establish()
    {
        _violation = new ConstraintViolation(_eventTypeId, EventSequenceNumber.First, ConstraintType.Unique, "Some Constraint", "Error", []);
