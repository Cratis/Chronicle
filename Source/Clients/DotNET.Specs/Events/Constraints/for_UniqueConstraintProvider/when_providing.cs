...
public class when_providing : Specification
{
    ...
    [Fact] void should_hold_first_event_property_for_first_constraint() => ((UniqueConstraintDefinition)_result[0]).EventsWithProperties.First().Properties.First().ShouldEqual(nameof(FirstEventWithFirstConstraint.firstEventWithFirstConstraintProperty));
    ...
    [Fact] void should_hold_second_event_property_for_first_constraint() => ((UniqueConstraintDefinition)_result[0]).EventsWithProperties.Last().Properties.First().ShouldEqual(nameof(SecondEventWithFirstConstraint.secondEventWithFirstConstraintProperty));
    ...
    [Fact] void should_hold_first_event_property_for_second_constraint() => ((UniqueConstraintDefinition)_result[1]).EventsWithProperties.First().Properties.First().ShouldEqual(nameof(FirstEventWithSecondConstraint.firstEventWithSecondConstraintProperty));
    ...
    [Fact] void should_hold_second_event_property_for_second_constraint() => ((UniqueConstraintDefinition)_result[1]).EventsWithProperties.Last().Properties.First().ShouldEqual(nameof(SecondEventWithSecondConstraint.secondEventWithSecondConstraintProperty));
