...
public class when_providing : Specification
{
    ...
    [Fact] void should_hold_first_event_type_for_first_constraint() => ((UniqueConstraintDefinition)_result[0]).EventsWithProperties.First().EventType.ShouldEqual(_firstEventWithFirstConstraintEventType);
    ...
    [Fact] void should_hold_second_event_type_for_first_constraint() => ((UniqueConstraintDefinition)_result[0]).EventsWithProperties.Last().EventType.ShouldEqual(_secondEventWithFirstConstraintEventType);
    ...
    [Fact] void should_hold_first_event_type_for_second_constraint() => ((UniqueConstraintDefinition)_result[1]).EventsWithProperties.First().EventType.ShouldEqual(_firstEventWithSecondConstraintEventType);
    ...
    [Fact] void should_hold_second_event_type_for_second_constraint() => ((UniqueConstraintDefinition)_result[1]).EventsWithProperties.Last().EventType.ShouldEqual(_secondEventWithSecondConstraintEventType);
