...
public class when_downcast_is_invoked_through_untyped_interface : Specification
{
    ...
    void Because() => ((IEventTypeMigration)_migration).Downcast(_builder);

    [Fact] void should_invoke_typed_downcast() => _migration.DowncastCalled.ShouldBeTrue();
