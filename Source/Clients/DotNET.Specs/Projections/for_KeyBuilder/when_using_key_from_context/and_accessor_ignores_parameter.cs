...
namespace Cratis.Chronicle.Projections.for_KeyBuilder.when_using_key_from_context;
...
public class and_accessor_ignores_parameter : Specification
{
    ...
    void Because()
    {
        ...
        _error = Catch.Exception(() => builder.UsingKeyFromContext(_ => System.DateTimeOffset.UtcNow));
    }
