...
public class on_decrement_attribute : given.a_model_bound_projection_builder
{
    ProjectionDefinition _result;

    void Establish()
    {
        event_types = new EventTypesForSpecifications([typeof(WithdrawalFromDebitAccountPerformed)]);
        builder = new ModelBoundProjectionBuilder(naming_policy, event_types);
    }

    void Because() => _result = builder.Build(typeof(AccountInfoWithConstantKeyOnDecrement));
