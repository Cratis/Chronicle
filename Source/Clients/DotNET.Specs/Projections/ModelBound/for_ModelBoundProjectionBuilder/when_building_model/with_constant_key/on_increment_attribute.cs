...
public class on_increment_attribute : given.a_model_bound_projection_builder
{
    ...
    void Because() => _result = builder.Build(typeof(AccountInfoWithConstantKeyOnIncrement));
