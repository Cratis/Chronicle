...
public class when_validating_non_existing_property : Specification
{
    Exception? _result;

    void Because() => _result = Catch.Exception(() => PropertyValidator.ValidatePropertyExists(typeof(TestClass), "NonExistingProperty"));
