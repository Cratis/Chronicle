...
public class for_two_different_models_and_client_is_disconnected : given.a_projection_watcher_manager
{
    ...
    [Fact] void should_not_start_watcher_for_some_model() => _expectedWatcherForSomeModel.DidNotReceive().Start();
    [Fact] void should_not_start_watcher_for_some_other_model() => _expectedWatcherForSomeOtherModel.DidNotReceive().Start();
}
