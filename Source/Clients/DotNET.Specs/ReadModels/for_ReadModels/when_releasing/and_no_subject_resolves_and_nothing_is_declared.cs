...
/// <summary>
/// The reported no-op, pinned as it stands. A read model with no <c language="csharp">[Subject]</c>, no <c language="csharp">Id</c> and no
...
/// computed <c language="csharp">[PII]</c> record. Per-property declarations must not change it; the declaration is how a read
