...
public class and_it_is_a_projection : given.all_dependencies
{
    ...
    ReadModelKey _key;
    ProjectionSnapshot<MyReadModel> _projectionSnapshot;
    ...
    void Establish()
    {
        ...
        _projectionSnapshot = new ProjectionSnapshot<MyReadModel>(
    ...
    [Fact] void should_return_snapshot_with_correct_correlation_id() => _result.First().CorrelationId.ShouldEqual(_projectionSnapshot.CorrelationId);
