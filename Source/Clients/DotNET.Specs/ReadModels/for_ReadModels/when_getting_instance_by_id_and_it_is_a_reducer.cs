...
public class when_getting_instance_by_id_and_it_is_a_reducer : given.all_dependencies
{
    ...
    void Establish()
    {
        ...
        _reducers.GetInstanceById(typeof(MyReadModel), _key)
            .Returns(new ReducerInstanceResult(_expectedModel, new EventSequenceNumber(42)));
    }
    ...
    [Fact] void should_check_if_reducer_exists() => _reducers.Received(1).HasFor(typeof(MyReadModel));
