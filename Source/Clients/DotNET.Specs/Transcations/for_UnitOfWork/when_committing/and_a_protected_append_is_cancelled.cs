...
public class and_a_protected_append_is_cancelled : given.a_unit_of_work
{
    Exception _caught;
    ...
    void Establish()
    {
        ...
        _eventSequence.AppendMany(
            ...
            .Returns(_ => Task.FromCanceled<AppendManyResult>(new CancellationToken(true)));
    }
    ...
    [Fact] void should_propagate_cancellation() => (_caught is OperationCanceledException).ShouldBeTrue();
