...
public class with_single_attribute_with_multiple_categories : Specification
{
    ...
    [Fact] void should_return_all_categories() => _result.ShouldContainOnly(["Analytics", "Reporting", "Dashboard"]);
}
