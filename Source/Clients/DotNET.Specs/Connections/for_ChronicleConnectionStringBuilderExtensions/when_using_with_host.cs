...
public class when_using_with_host : Specification
{
    ...
    void Because() => _result = _builder.WithHost("example.com");

    [Fact] void should_set_host() => _builder.Host.ShouldEqual("example.com");
