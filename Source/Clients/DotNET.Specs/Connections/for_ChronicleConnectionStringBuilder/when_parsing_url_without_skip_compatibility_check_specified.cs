...
public class when_parsing_url_without_skip_compatibility_check_specified : Specification
{
    ...
    [Fact] void should_perform_the_compatibility_check_by_default() => _builder.SkipCompatibilityCheck.ShouldBeFalse();
}
