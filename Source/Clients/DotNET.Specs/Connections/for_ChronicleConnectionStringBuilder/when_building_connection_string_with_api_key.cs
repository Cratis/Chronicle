...
public class when_building_connection_string_with_api_key : Specification
{
    ...
    [Fact] void should_include_api_key_in_query_string() => _url.ShouldEqual("chronicle://localhost:35000?apiKey=my-api-key");
}
