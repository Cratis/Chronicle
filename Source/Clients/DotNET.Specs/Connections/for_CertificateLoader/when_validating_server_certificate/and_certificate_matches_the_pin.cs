...
public class and_certificate_matches_the_pin : Specification
{
    ...
    void Because() => _result = CertificateLoader
        .CreateServerCertificateValidationCallback(skipTlsValidation: false, pinnedCertificateHash: _certificate.GetCertHashString())
        .Invoke(this, _certificate, null, SslPolicyErrors.RemoteCertificateChainErrors);

    [Fact] void should_accept_the_pinned_certificate() => _result.ShouldBeTrue();
