...
public class handler_method_returning_event_from_reactor_implementing_ICanProvideEventSourceId : Specification
{
    ...
    EventSourceId _reactorEventSourceId;
    ...
    void Establish()
    {
        ...
        _reactorEventSourceId = EventSourceId.New();
        ...
        var reactor = new ReactorWithCustomEventSourceId(_outboundEvent, _reactorEventSourceId);

        _invoker = new ReactorInvoker(
            eventTypes,
            _middlewares,
            typeof(ReactorWithCustomEventSourceId),
    ...
    [Fact] void should_append_to_event_log_with_reactor_event_source_id() =>
        _eventLog.Received(1).Append(_reactorEventSourceId, _outboundEvent, default, default, default, default, default, default, default, default);

    class ReactorWithCustomEventSourceId(MyOutboundEvent outbound, EventSourceId eventSourceId) : IReactor, ICanProvideEventSourceId
    {
