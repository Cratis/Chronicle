...
public class handler_method_returning_task_of_events_for_event_source_ids : Specification
{
    ...
    void Establish()
    {
        ...
        var reactor = new ReactorWithTaskOfEventsForEventSourceIdsReturnType(_firstEventSourceId, _secondEventSourceId);

        _invoker = new ReactorInvoker(
            eventTypes,
            _middlewares,
            typeof(ReactorWithTaskOfEventsForEventSourceIdsReturnType),
            new ActivatedArtifact(reactor, typeof(ReactorWithTaskOfEventsForEventSourceIdsReturnType), Substitute.For<ILogger<ActivatedArtifact>>()),
    ...
    class ReactorWithTaskOfEventsForEventSourceIdsReturnType(EventSourceId firstEventSourceId, EventSourceId secondEventSourceId) : IReactor
    {
        public Task<IEnumerable<EventForEventSourceId>> Handle(MyEvent @event) =>
