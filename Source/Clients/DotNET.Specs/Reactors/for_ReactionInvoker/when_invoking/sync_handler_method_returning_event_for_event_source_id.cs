...
public class sync_handler_method_returning_event_for_event_source_id : Specification
{
    ...
    void Establish()
    {
        ...
        var reactor = new ReactorWithEventForEventSourceIdReturnType(_targetEventSourceId, _outboundEvent);
    ...
    class ReactorWithEventForEventSourceIdReturnType(EventSourceId eventSourceId, MyOutboundEvent outbound) : IReactor
    {
        public EventForEventSourceId Handle(MyEvent @event) => new(eventSourceId, outbound);
    }
}
