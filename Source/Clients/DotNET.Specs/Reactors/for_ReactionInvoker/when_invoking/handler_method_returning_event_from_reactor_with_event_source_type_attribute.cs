...
public class handler_method_returning_event_from_reactor_with_event_source_type_attribute : Specification
{
    ...
    void Establish()
    {
        ...
        _invoker = new ReactorInvoker(
            eventTypes,
            _middlewares,
            typeof(ReactorWithEventSourceTypeAttribute),
    ...
    [Fact] void should_append_to_event_log_with_reactor_event_source_type() =>
        _eventLog.Received(1).Append(_eventContext.EventSourceId, _outboundEvent, default, default, new EventSourceType("my-source"), default, default, default, default, default);

    [EventSourceType("my-source")]
    class ReactorWithEventSourceTypeAttribute(MyOutboundEvent outbound) : IReactor
    {
