...
public class when_has_concurrency_violations : Specification
{
    ...
    void Establish()
    {
        _violation = new ConcurrencyViolation("event-source-id", 42ul, 43ul);
    ...
    [Fact] void should_return_the_violation() => _result.ConcurrencyViolations.First().ShouldEqual(_violation);
}
