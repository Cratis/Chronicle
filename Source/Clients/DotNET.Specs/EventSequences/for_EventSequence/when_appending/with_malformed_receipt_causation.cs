...
public class with_malformed_receipt_causation : given.an_acknowledged_append
{
    void Establish() => _response.Receipt.Causation.Single().Occurred.Value = "not-a-timestamp";
