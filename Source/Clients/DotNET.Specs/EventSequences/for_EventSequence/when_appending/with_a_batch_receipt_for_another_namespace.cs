...
public class with_a_batch_receipt_for_another_namespace : given.an_acknowledged_append
{
    void Establish() => _batchResponse.Receipts.Last().Namespace = "another-namespace";
