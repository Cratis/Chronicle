...
public class with_batch_receipts_for_another_store : given.an_acknowledged_append
{
    void Establish()
    {
        foreach (var receipt in _batchResponse.Receipts)
        {
            receipt.EventStore = "another-store";
        }
    }
