...
public class when_adding_chronicle_client_with_custom_type : Specification
{
    ...
    void Establish()
    {
        ...
        _services.Configure<ChronicleAspNetCoreOptions>(options =>
        {
            ...
            options.EventStoreNamespaceResolverType = typeof(DefaultEventStoreNamespaceResolver);
        });
    }
    ...
    [Fact] void should_use_configured_type() => _resolver.ShouldBeOfExactType<DefaultEventStoreNamespaceResolver>();
}
