...
public class when_a_compliance_provider_cannot_be_resolved : Specification
{
    ...
    void Establish()
    {
        _failure = new Exception("Compliance dependency is unavailable");
        ...
        _artifacts.ComplianceForTypesProviders.Returns([typeof(PIIMetadataProvider)]);
    }
