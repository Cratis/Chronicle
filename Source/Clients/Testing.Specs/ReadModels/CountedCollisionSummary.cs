...
/// <see cref="CandidateSubmitted"/> — which happens to carry an identically named <c language="csharp">Location</c>. Unlike
/// <see cref="ArrangementSummary"/> it carries NO <c language="csharp">[NoAutoMap]</c>: the aggregate heuristic must recognize
/// that <see cref="CandidateSubmitted"/> is subscribed only to be counted and therefore not auto-map its
/// <c language="csharp">Location</c> over the explicitly sourced value.
/// </summary>
