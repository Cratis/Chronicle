...
public class and_child_is_seeded_before_parent : Specification
{
    ...
    [Fact] void should_not_reapply_the_root_mapping() => _scenario.Instance!.TotalAmount.ShouldEqual(7);
}
