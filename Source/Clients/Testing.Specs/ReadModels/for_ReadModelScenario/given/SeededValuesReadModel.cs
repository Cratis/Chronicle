...
/// <summary>
/// Projects a note onto a read model whose scalar, concept and dictionary values only ever come from the initial state.
/// </summary>
...
/// <param name="Note">The note set by <see cref="SeededValuesNoted"/>.</param>
[Passive]
[FromEvent<SeededValuesNoted>]
public record SeededValuesReadModel(
    Guid Id,
    string Name,
    int Count,
