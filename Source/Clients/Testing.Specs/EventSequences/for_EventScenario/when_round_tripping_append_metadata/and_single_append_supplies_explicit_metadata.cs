...
public class and_single_append_supplies_explicit_metadata : Specification, IDisposable
{
    ...
    async Task Because()
    {
        _result = await _scenario.EventLog.Append(_source, new TestEvent("first"), eventStreamType: "Payments", eventStreamId: "September", eventSourceType: "Account");
