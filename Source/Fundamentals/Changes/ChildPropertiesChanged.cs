...
namespace Aksio.Cratis.Changes
{
    ...
    public record ChildPropertiesChanged<TTarget>(object State, PropertyPath ChildrenProperty, PropertyPath IdentifiedByProperty, object Key, IEnumerable<PropertyDifference> Differences) : Change(State);
}
