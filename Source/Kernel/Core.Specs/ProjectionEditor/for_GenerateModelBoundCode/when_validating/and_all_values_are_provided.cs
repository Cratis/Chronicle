...
namespace Cratis.Chronicle.ProjectionEditor.for_GenerateModelBoundCode.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new GenerateModelBoundCode("some-event-store", "some-namespace", "some declaration"));
