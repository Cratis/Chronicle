...
public class and_existing_events_follow_added_events : Specification
{
    ...
    [Fact] void should_require_full_replay() => _result.Operation.ShouldEqual(DefinitionEvolutionOperation.FullReplay);
