...
public class and_there_are_pending_entries : given.a_catching_up_in_flight_state
{
    ...
    void Establish() =>
        ...
        {
            LastHandledEventSequenceNumber = (EventSequenceNumber)9UL,
    ...
    [Fact] void should_not_transition_to_quarantined() => _stateMachine.DidNotReceive().TransitionTo<QuarantinedObserver>();
}
