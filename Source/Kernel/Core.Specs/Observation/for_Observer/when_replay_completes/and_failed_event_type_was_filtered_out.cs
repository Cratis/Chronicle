...
public class and_failed_event_type_was_filtered_out : given.an_observer
{
    ...
    async Task Because() => await _observer.ReplayedSuccessfullySince(42UL, new Dictionary<Key, EventSequenceNumber> { [_partition] = 42UL }, [_replayedType], DateTimeOffset.UtcNow);
