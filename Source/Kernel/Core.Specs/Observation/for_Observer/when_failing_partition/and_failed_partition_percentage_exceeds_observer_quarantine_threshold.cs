...
public class and_failed_partition_percentage_exceeds_observer_quarantine_threshold : given.an_observer_with_subscription
{
    void Establish() => _configurationProvider.GetFor(Arg.Any<string>()).Returns(new Observers { QuarantineOnFailedPartitionPercentage = 0.5 });
