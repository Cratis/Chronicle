...
namespace Cratis.Chronicle.Observation.for_ObserverState.when_Setting_next_event_sequence_number;
...
public class and_value_is_max : Specification
{
    ...
    void Because() => _state = _state with { NextEventSequenceNumber = EventSequenceNumber.Max };
