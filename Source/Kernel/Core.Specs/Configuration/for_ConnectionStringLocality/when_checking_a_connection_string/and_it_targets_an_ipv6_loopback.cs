...
public class and_it_targets_an_ipv6_loopback : Specification
{
    const string ConnectionString = "mongodb://[::1]:27017";
    bool _result;

    void Because() => _result = ConnectionStringLocality.IsNonLocal(ConnectionString);

    [Fact] void should_be_local() => _result.ShouldBeFalse();
}
