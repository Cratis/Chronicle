...
public class and_concurrency_violation_detected : given.a_concurrency_validator
{
    ...
    [Fact] void should_return_violation_with_expected_sequence_number() => _result.AsT0.ExpectedSequenceNumber.Value.ShouldEqual(42UL);
