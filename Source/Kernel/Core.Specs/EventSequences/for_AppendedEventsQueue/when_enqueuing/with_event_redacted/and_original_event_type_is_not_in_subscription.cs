...
public class and_original_event_type_is_not_in_subscription : given.a_single_subscriber_with_event_redacted_event_type
{
    ...
    void Establish()
    {
        ...
        content.originalEventType = "AnotherEventTypeNotInSubscription";
