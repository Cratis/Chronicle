...
public class when_releasing_a_property_the_schema_does_not_declare : given.a_value_handler_and_a_type_with_one_property
{
    ...
    [Fact] void should_fail_with_the_property_not_found_exception() => _exception.ShouldBeOfExactType<SchemaPropertyNotFoundInSchema>();
    ...
    [Fact] void should_name_the_action() => _exception.Message.ShouldContain(SchemaMetadataActionFailed.ReleaseAction);
