...
public class and_added_events_change_an_existing_property : given.a_projection_replay_recommendation_evaluator
{
    bool _result;
    ...
    void Because()
    {
        ...
        var current = CreateDefinition(from: new Dictionary<EventType, FromDefinition>
        {
            ...
            [EventType2] = new(new Dictionary<PropertyPath, string> { ["name"] = "newName" }, PropertyExpression.NotSet, null)
        }) with { AutoMap = AutoMap.Disabled };
