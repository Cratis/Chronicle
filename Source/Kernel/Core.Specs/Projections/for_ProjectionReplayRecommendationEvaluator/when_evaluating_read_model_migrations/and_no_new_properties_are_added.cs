...
public class and_no_new_properties_are_added : given.a_projection_replay_recommendation_evaluator
{
    ...
    [Fact] void should_require_replay() => _result.ShouldEqual(ProjectionReadModelMigrationRecommendation.ReplayRequired);
}
