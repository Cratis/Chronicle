...
public class when_child_does_not_handle_the_event : given.a_handle_event_step
{
    ...
    void Establish()
    {
        ...
        _childProjection.HasKeyResolverFor(_event.Context.EventType).Returns(false);
    ...
    [Fact] void should_not_recurse_into_the_child() => _childProjection.DidNotReceive().Accepts(Arg.Any<EventType>());
