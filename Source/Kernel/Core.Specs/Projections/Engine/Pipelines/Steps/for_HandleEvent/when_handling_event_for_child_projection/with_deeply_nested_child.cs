...
namespace Cratis.Chronicle.Projections.Engine.Pipelines.Steps.for_HandleEvent.when_handling_event_for_child_projection;

public class with_deeply_nested_child : given.a_handle_event_step
{
    ...
    void Establish()
    {
        ...
        initialState.SomeNestedProperty = "nested value";

        _projection.ChildrenPropertyPath.Returns(new PropertyPath("Configurations.Hubs"));
