...
public class when_projecting_nested_object : given.an_observable_and_event_setup
{
    ...
    [Fact] void should_call_set_properties_on_changeset() => _changeset.Received(1).SetProperties(_propertyMappers, _eventContext.Key.ArrayIndexers);
}
