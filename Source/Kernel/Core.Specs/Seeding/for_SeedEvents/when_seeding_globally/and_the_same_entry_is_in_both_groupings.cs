...
public class and_the_same_entry_is_in_both_groupings : given.a_seeding_grain
{
    ...
    [Fact] void should_keep_each_event_source_in_the_order_the_seeder_wrote() => EntriesSeededGlobally.Select(_ => $"{_.EventSourceId}/{_.EventTypeId}").ToArray().ShouldEqual(["timesheet-1/submitted", "timesheet-1/approved", "timesheet-2/submitted"]);
}
