...
/// one entry.
/// </summary>
public class and_an_entry_is_only_in_one_grouping : given.a_seeding_grain
{
    SeedEvents _request;

    void Establish() => _request = new SeedEvents(
        TheEventStore,
        [
            new Contracts.Seeding.EventTypeSeedEntries
            {
        ...
        [
            new Contracts.Seeding.EventSourceSeedEntries
            {
