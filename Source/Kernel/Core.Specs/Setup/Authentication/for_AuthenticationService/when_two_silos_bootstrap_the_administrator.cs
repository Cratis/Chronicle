...
public class when_two_silos_bootstrap_the_administrator : Specification
{
    ...
    void Establish()
    {
        ...
        _users.GetById(UserId.InitialAdministrator).Returns(new User { Id = UserId.InitialAdministrator, Username = "admin" });
    ...
    async Task Because()
    {
        await Task.WhenAll(_first.EnsureDefaultAdminUser(), _second.EnsureDefaultAdminUser());
    }
