...
public class when_another_request_sets_the_password_first : Specification
{
    ...
    void Establish()
    {
        ...
        _users.GetByUsername("admin").Returns(new StoredUser { Id = _administratorId, Username = "admin" });
    ...
    [Fact] void should_report_that_setup_already_completed() => _exception.ShouldBeOfExactType<InitialAdminPasswordAlreadyUsed>();
}
