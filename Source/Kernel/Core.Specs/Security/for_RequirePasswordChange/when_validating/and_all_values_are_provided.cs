...
namespace Cratis.Chronicle.Security.for_RequirePasswordChange.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new RequirePasswordChange(Guid.NewGuid()));
