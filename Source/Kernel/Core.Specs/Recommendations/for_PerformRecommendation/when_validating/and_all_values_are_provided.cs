...
namespace Cratis.Chronicle.Recommendations.for_PerformRecommendation.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new PerformRecommendation("some-event-store", "some-namespace", Guid.NewGuid()));
