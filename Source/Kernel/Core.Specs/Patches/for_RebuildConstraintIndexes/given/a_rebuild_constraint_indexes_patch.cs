...
namespace Cratis.Chronicle.Core.Specs.Patches.for_RebuildConstraintIndexes.given;

public class a_rebuild_constraint_indexes_patch : Specification
{
    protected RebuildConstraintIndexes _patch;
    ...
    void Establish()
    {
        ...
        _patch = new RebuildConstraintIndexes(_storage, _grainFactory, Substitute.For<ILogger<RebuildConstraintIndexes>>());
    }
}
