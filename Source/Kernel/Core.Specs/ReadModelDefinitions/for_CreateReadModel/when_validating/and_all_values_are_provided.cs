...
namespace Cratis.Chronicle.ReadModelDefinitions.for_CreateReadModel.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new CreateReadModel("some-event-store", "some-identifier", "Some Display Name", "some-container"));
