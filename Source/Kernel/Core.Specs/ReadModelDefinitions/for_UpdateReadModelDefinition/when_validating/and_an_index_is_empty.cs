...
public class and_an_index_is_empty : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new UpdateReadModelDefinition("some-event-store", "some-identifier", "some-container", 1, "{}", [string.Empty]));
