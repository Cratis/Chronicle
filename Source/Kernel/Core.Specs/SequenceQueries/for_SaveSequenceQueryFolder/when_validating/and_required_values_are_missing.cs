...
public class and_required_values_are_missing : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new SaveSequenceQueryFolder(string.Empty, string.Empty, SequenceQueryScope.User, string.Empty, string.Empty));
