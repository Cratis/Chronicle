...
namespace Cratis.Chronicle.SequenceQueries.for_DeleteSequenceQueryFolder.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new DeleteSequenceQueryFolder("some-event-store", "some-folder"));
