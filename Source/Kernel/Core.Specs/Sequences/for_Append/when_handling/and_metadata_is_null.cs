...
public class and_metadata_is_null : Sequences.given.an_append_endpoint
{
    async Task Because() => await new Append("store", "namespace", "event-log", "source", null!, null!, null!, new EventType("event", 1, false), "{}")
