...
public class and_required_values_are_missing : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new AddExternalService(string.Empty, string.Empty, string.Empty, ExternalServiceEndpointType.Http, string.Empty, AuthorizationType.None, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, new Dictionary<string, string>(), string.Empty, 0, string.Empty, string.Empty, string.Empty, new Dictionary<string, string>()));
