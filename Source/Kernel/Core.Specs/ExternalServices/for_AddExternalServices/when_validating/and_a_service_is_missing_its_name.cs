...
namespace Cratis.Chronicle.ExternalServices.for_AddExternalServices.when_validating;

public class and_a_service_is_missing_its_name : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new AddExternalServices("some-event-store", [new ExternalServiceDefinition()]));
