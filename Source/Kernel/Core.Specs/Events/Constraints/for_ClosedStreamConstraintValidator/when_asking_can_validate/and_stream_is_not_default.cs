...
public class and_stream_is_not_default : given.a_closed_stream_constraint_validator
{
    bool _result;
    ...
    void Establish() =>
        _context = new(
            ...
            new ExpandoObject(),
            eventStreamType: new EventStreamType("invoices"),
            eventStreamId: new EventStreamId("invoices-001"));
