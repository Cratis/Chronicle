...
public class and_event_type_for_event_source_id_is_not_allowed_with_scope : Specification
{
    ...
    void Establish()
    {
        ...
        _storage.IsAllowed(Arg.Is<UniqueEventTypeConstraintDefinition>(_ => _.EventTypeIds.Contains(eventType.Id)), _context.EventSourceId, new ResolvedConstraintScope(EventSourceType: "MySourceType")).Returns((false, 42U));
    }
