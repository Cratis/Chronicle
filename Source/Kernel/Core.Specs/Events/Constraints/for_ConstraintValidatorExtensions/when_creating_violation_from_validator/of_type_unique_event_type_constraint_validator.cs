...
namespace Cratis.Chronicle.Events.Constraints.for_ConstraintValidatorExtensions.when_creating_violation_from_validator;

public class of_type_unique_event_type_constraint_validator : given.a_constraint_validation_context
{
