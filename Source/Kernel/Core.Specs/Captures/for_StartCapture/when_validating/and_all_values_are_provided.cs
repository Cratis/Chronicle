...
namespace Cratis.Chronicle.Captures.for_StartCapture.when_validating;
...
public class and_all_values_are_provided : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new StartCapture("some-event-store", Guid.NewGuid()));
