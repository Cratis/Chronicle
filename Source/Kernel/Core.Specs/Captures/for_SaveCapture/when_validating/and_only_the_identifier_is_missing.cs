...
public class and_only_the_identifier_is_missing : Specification
{
    ...
    async Task Because() => _result = await _scenario.Validate(new SaveCapture("some-event-store", Guid.Empty, "some declaration"));
