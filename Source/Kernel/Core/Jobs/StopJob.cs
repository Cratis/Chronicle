...
public record StopJob(EventStoreName EventStore, EventStoreNamespaceName Namespace, Cratis.Orleans.Jobs.JobId JobId)
{
    /// <summary>
    /// Handles the command by invoking <see cref="Cratis.Orleans.Jobs.IJobsManager.Stop"/> on the jobs manager grain.
    /// </summary>
