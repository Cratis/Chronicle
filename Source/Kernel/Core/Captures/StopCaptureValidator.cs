...
/// <summary>
/// Represents the validator for <see cref="StopCapture"/>.
/// </summary>
internal class StopCaptureValidator : CommandValidator<StopCapture>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StopCaptureValidator"/> class.
    /// </summary>
    /// <param name="storage">The <see cref="IStorage"/> to check for the capture's existence in.</param>
    public StopCaptureValidator(IStorage storage)
    {
