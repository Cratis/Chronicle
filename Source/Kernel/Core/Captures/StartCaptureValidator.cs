...
/// <summary>
/// Represents the validator for <see cref="StartCapture"/>.
/// </summary>
internal class StartCaptureValidator : CommandValidator<StartCapture>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StartCaptureValidator"/> class.
    /// </summary>
    /// <param name="storage">The <see cref="IStorage"/> to check for the capture's existence in.</param>
    public StartCaptureValidator(IStorage storage)
    {
