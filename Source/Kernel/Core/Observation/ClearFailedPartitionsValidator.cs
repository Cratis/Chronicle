...
/// <summary>
/// Represents the validator for <see cref="ClearFailedPartitions"/>.
/// </summary>
internal class ClearFailedPartitionsValidator : CommandValidator<ClearFailedPartitions>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClearFailedPartitionsValidator"/> class.
    /// </summary>
    public ClearFailedPartitionsValidator()
    {
