...
/// <summary>
/// Represents the validator for <see cref="ClearObserverQuarantine"/>.
/// </summary>
internal class ClearObserverQuarantineValidator : CommandValidator<ClearObserverQuarantine>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClearObserverQuarantineValidator"/> class.
    /// </summary>
    public ClearObserverQuarantineValidator()
    {
