...
/// <summary>
/// Represents a <see cref="IJsonCompliancePropertyValueHandler"/> for a globally-scoped, plain-confidentiality
...
{
    /// <inheritdoc/>
    public ComplianceMetadataType Type => ComplianceMetadataType.EncryptedGlobal;
