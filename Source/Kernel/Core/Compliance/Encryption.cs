...
/// AES-256-GCM data key, and only that 32-byte data key is wrapped with the per-subject RSA key. This
...
public class Encryption : IEncryption
{
    ...
    static byte[] WrapDataKey(byte[] dataKey, EncryptionKey key)
    {
        ...
        return provider.Encrypt(dataKey, RSAEncryptionPadding.Pkcs1);
    }
    ...
    static byte[] UnwrapDataKey(byte[] wrappedKey, EncryptionKey key)
    {
        ...
        return provider.Decrypt(wrappedKey, RSAEncryptionPadding.Pkcs1);
    }
