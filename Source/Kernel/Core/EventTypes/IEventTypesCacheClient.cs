...
/// <summary>
/// Defines a client that evicts an event type from the caches on every silo in the cluster.
/// </summary>
public interface IEventTypesCacheClient
{
    /// <summary>
    /// Evict an event type from the caches on every silo in the cluster.
    /// </summary>
