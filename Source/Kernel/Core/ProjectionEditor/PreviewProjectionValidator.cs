...
/// <summary>
/// Represents the validator for <see cref="PreviewProjection"/>.
/// </summary>
internal class PreviewProjectionValidator : CommandValidator<PreviewProjection>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PreviewProjectionValidator"/> class.
    /// </summary>
    public PreviewProjectionValidator()
    {
