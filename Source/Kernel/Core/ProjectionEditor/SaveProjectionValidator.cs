...
/// <summary>
/// Represents the validator for <see cref="SaveProjection"/>.
/// </summary>
internal class SaveProjectionValidator : CommandValidator<SaveProjection>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SaveProjectionValidator"/> class.
    /// </summary>
    public SaveProjectionValidator()
    {
