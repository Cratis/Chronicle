...
/// <summary>
/// Represents a <see cref="JsonConverter"/> for read-only dictionaries with concept keys.
/// </summary>
/// <typeparam name="TKey">The concept key type.</typeparam>
/// <typeparam name="TValue">The value type.</typeparam>
public class ConceptReadOnlyDictionaryJsonConverter<TKey, TValue> : JsonConverter<IReadOnlyDictionary<TKey, TValue>>
    where TKey : notnull
{
    /// <inheritdoc/>
