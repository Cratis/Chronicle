...
/// <param name="RecommendationId">The unique identifier of the recommendation to stop ignoring.</param>
[Command]
[BelongsTo(WellKnownServices.Recommendations)]
public record UnignoreRecommendation(EventStoreName EventStore, EventStoreNamespaceName Namespace, Concepts.Recommendations.RecommendationId RecommendationId)
{
    /// <summary>
    /// Handles the command by asking the recommendations manager grain to stop ignoring the recommendation.
    /// </summary>
