...
/// <summary>
/// Represents the validator for <see cref="UnignoreRecommendation"/>.
/// </summary>
internal class UnignoreRecommendationValidator : CommandValidator<UnignoreRecommendation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UnignoreRecommendationValidator"/> class.
    /// </summary>
    public UnignoreRecommendationValidator()
    {
