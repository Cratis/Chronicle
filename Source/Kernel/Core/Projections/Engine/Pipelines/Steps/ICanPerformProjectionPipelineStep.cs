...
public interface ICanPerformProjectionPipelineStep
{
    ...
    /// Perform the step.
    /// </summary>
    /// <param name="projection"><see cref="IProjection"/> to perform for.</param>
    ...
    ValueTask<ProjectionEventContext> Perform(IProjection projection, ProjectionEventContext context);
}
