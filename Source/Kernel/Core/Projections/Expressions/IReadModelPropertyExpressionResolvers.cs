...
/// <summary>
/// Defines a system for resolving a read model property expression. It represents known expression resolvers in the system.
/// </summary>
public interface IReadModelPropertyExpressionResolvers
{
    /// <summary>
