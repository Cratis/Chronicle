...
public class and_scope_has_no_dimensions : Specification
{
    string _result;

    void Because() => _result = ConstraintScope.None.BuildScopeKey(EventSourceType.Default, EventStreamType.All, EventStreamId.Default);
