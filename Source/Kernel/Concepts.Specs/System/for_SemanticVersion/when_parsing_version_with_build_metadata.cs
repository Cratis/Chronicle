...
public class when_parsing_version_with_build_metadata : Specification
{
    SemanticVersion _result;

    void Because() => _result = SemanticVersion.Parse("1.2.3+build.123");
    ...
    [Fact] void should_have_correct_build_metadata() => _result.BuildMetadata.ShouldEqual("build.123");
}
