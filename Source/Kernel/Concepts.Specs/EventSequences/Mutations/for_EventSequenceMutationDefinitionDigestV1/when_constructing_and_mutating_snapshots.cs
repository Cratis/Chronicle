...
namespace Cratis.Chronicle.Concepts.EventSequences.Mutations.for_EventSequenceMutationDefinitionDigestV1;

public class when_constructing_and_mutating_snapshots : Specification
{
    byte[] _source;
    EventSequenceMutationDefinitionDigestV1 _digest;
    EventSequenceMutationDefinitionDigestV1 _equalDigest;
    byte[] _firstSnapshot;
