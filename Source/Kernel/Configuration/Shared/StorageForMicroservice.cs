...
/// <summary>
/// Represents the storage configuration for all <see cref="StorageType">storage types</see> within a microservice.
/// </summary>
public class StorageForMicroservice : Dictionary<string, StorageType>
{
    /// <summary>
