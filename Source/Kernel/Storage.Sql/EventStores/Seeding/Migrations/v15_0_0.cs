...
namespace Cratis.Chronicle.Storage.Sql.EventStores.Seeding.Migrations;

#nullable disable
#pragma warning disable SA1600, SA1402, MA0048

[DbContext(typeof(EventStoreDbContext))]
[Migration($"ES-{WellKnownTableNames.EventSeeds}-{nameof(v15_0_0)}")]
public class v15_0_0 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey($"PK_ES_{WellKnownTableNames.EventSeeds}", x => x.Id));
    }
