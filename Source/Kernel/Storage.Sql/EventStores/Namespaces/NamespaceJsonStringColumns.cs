...
/// requires the explicit binding because its <c language="csharp">jsonb</c> type does not accept implicit casts
/// from <c language="csharp">text</c>. This is a temporary workaround until <c language="csharp">JsonColumn&lt;string&gt;</c> in
/// <c language="csharp">Cratis.Arc.EntityFrameworkCore</c> registers the entity column mapping automatically.
/// </summary>
