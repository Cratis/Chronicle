...
namespace Aksio.Cratis.Events.Projections.Pipelines
{
    ...
    public interface IProjectionPipelineHandler
    {
        ...
        /// </summary>
        IReadOnlyDictionary<ProjectionSinkConfigurationId, EventLogSequenceNumber> CurrentPositions { get; }
        ...
        Task<EventLogSequenceNumber> Handle(AppendedEvent @event, IProjectionPipeline pipeline, IProjectionSink sink, ProjectionSinkConfigurationId configurationId);
    }
}
