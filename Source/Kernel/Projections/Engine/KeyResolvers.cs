...
public static class KeyResolvers
{
    ...
    public static readonly KeyResolver FromEventSourceId = (IEventLogStorageProvider eventProvider, AppendedEvent @event) => Task.FromResult(new Key(EventValueProviders.FromEventSourceId(@event), ArrayIndexers.NoIndexers))!;
    ...
    {
        return (IEventLogStorageProvider eventProvider, AppendedEvent @event) =>
        {
    ...
    {
        return async (IEventLogStorageProvider eventProvider, AppendedEvent @event) =>
        {
            var arrayIndexers = new List<ArrayIndexer>();
