...
public interface IObserverDefinitionsStorage
{
    ...
    /// </summary>
    /// <param name="eventTypes">Collection of <see cref="EventType"/> to get for.</param>
    /// <returns>Collection of <see cref="ObserverDefinition"/> for observers that support replay and observe the given event types.</returns>
    Task<IEnumerable<ObserverDefinition>> GetReplayableObserversForEventTypes(IEnumerable<EventType> eventTypes);
}
