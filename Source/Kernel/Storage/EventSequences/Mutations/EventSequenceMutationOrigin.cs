...
/// </summary>
/// <param name="Sequence">The event sequence containing the originating event.</param>
/// <param name="SequenceNumber">The sequence number of the originating event.</param>
public sealed record EventSequenceMutationOrigin(EventSequenceId Sequence, EventSequenceNumber SequenceNumber);
