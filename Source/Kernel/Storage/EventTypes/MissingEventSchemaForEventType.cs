...
public class MissingEventSchemaForEventType(EventStoreName eventStore, EventTypeId type, EventTypeGeneration generation) : Exception($"Event type '{type}' with generation '{generation}' is missing from the event store '{eventStore}'")
{
}
