...
public class with_a_different_origin_position : given.a_mutation_validation
{
    bool _result;

    void Because() => _result = _request.ExactlyEquals(_request with { Origin = _request.Origin with { SequenceNumber = 2UL } });
