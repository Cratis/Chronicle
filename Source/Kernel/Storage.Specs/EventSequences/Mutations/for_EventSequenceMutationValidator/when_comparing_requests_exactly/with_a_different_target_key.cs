...
public class with_a_different_target_key : given.a_mutation_validation
{
    bool _result;

    void Because() => _result = _request.ExactlyEquals(_request with { TargetSequence = IdentityWithKeyFrom("event-log", "other") });
