...
public class with_a_different_kind : given.a_mutation_validation
{
    bool _result;

    void Because() => _result = _request.ExactlyEquals(_request with { Kind = EventSequenceMutationKind.PointRedaction });
