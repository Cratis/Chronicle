...
public class with_a_different_command_hash : given.a_mutation_validation
{
    bool _result;

    void Because() => _result = _request.ExactlyEquals(_request with { Command = _request.Command with { Hash = "SAME-HASH" } });
