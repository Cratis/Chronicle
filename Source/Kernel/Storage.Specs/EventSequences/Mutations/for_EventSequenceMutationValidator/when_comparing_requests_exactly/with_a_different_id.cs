...
public class with_a_different_id : given.a_mutation_validation
{
    bool _result;

    void Because() => _result = _request.ExactlyEquals(_request with { Id = Guid.Parse("10112233-4455-6677-8899-aabbccddeeff") });
