...
public class when_getting_for_unknown_type : Specification
{
    ...
    void Because() => _result = Catch.Exception(() => _sinks.GetFor("bc5e82fd-9845-4464-9802-a7e21bd8a919", SinkConfigurationId.None, new ReadModelDefinition(string.Empty, null!)));
