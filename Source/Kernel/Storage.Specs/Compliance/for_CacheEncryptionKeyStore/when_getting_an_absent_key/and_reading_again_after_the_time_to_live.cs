...
public class and_reading_again_after_the_time_to_live : given.a_cache_over_a_store_without_the_key
{
    ...
    [Fact] void should_query_the_actual_store_again() => _actualStore.Received(2).TryGetFor(string.Empty, string.Empty, _identifier);
