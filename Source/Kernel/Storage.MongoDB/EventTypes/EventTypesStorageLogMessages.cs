...
internal static partial class EventTypesStorageLogMessages
{
    ...
    internal static partial void Populating(this ILogger<EventTypesStorage> logger, EventStore eventStore);
    ...
    internal static partial void Registering(this ILogger<EventTypesStorage> logger, string name, EventTypeId eventType, EventGeneration generation, EventStore eventStore);
}
