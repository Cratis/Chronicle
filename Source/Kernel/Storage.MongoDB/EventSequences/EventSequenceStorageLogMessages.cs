...
internal static partial class EventSequenceStorageLogMessages
{
    ...
    [LoggerMessage(LogLevel.Information, "Revising event with sequence number {EventSequenceNumber} from sequence {EventSequenceId}")]
    internal static partial void Revising(this ILogger<EventSequenceStorage> logger, EventSequenceId eventSequenceId, EventSequenceNumber eventSequenceNumber);
