...
public static partial class EventSequenceLogMessages
{
    ...
    internal static partial void Appending(this ILogger logger, EventType eventType, EventSourceId eventSource, ulong sequenceNumber, EventSequenceId eventLog);

    [LoggerMessage(1, LogLevel.Information, "Compensatin event @ {SequenceNumber} in event log '{EventLog}' - event type '{EventType}'")]
    internal static partial void Compensating(this ILogger logger, EventType eventTYpe, ulong sequenceNumber, EventSequenceId eventLog);
    ...
    internal static partial void ErrorAppending(this ILogger logger, EventSequenceId eventLogId, ulong sequenceNumber, Guid tenantId, string eventSourceId, Exception exception);
}
