...
public class when_configuring_orleans_before_arc_mongodb_with_scope_validation : Specification
{
    const string ConnectionString = "mongodb://reverse-order-host:27019/?directConnection=true";
    ...
    [Fact] void should_use_the_configured_server_for_orleans() => AssertAfterSuccessfulBuild(() => _orleansMongoClient.Settings.Server.Host.ShouldEqual("reverse-order-host"));
    [Fact] void should_use_the_configured_port_for_orleans() => AssertAfterSuccessfulBuild(() => _orleansMongoClient.Settings.Server.Port.ShouldEqual(27019));
