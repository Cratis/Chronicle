...
public class and_the_retry_fails : given.an_ordered_bulk_with_a_null_parent_failure
{
    void Establish() => _failRetry = true;
    ...
    [Fact] void should_not_resume_the_suffix() => _batchSizes.ShouldContainOnly([3, 1]);
}
