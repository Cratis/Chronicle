...
public class when_converting_expando_object_with_nested_child_having_pascal_case_id_to_bson_document : given.an_expando_object_converter_with_children_having_id_pascal_case_schema
{
    ...
    [Fact] void should_not_include_parent_pascal_case_id_property() => _result.Contains("Id").ShouldBeFalse();
    ...
    [Fact] void should_not_include_child_pascal_case_id_property() => _result.GetElement("Items").Value.AsBsonArray[0].AsBsonDocument.Contains("Id").ShouldBeFalse();
