...
public class and_the_constraint_is_scoped_to_the_event_stream_id(MongoDBFixture fixture) : given.a_unique_event_types_constraints_storage(fixture)
{
    ...
    async Task Establish() => await Append(_checkedOutEventType, _borrower, eventStreamId: _thisBranch);
