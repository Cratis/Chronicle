...
namespace Cratis.Chronicle.Storage.MongoDB.Events.Constraints.for_UniqueEventTypesConstraintsStorage.when_checking_if_allowed_with_a_flattened_scope_key;
...
public class and_the_key_names_a_scope(MongoDBFixture fixture) : given.a_unique_event_types_constraints_storage(fixture)
{
    ...
    async Task Establish()
    {
        ...
        await Append(_checkedOutEventType, _borrower, _eventSourceType, _eventStreamType, _eventStreamId);
    }
