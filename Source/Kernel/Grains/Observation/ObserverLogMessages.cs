...
internal static partial class ObserverLogMessages
{
    ...
    internal static partial void Unsubscribing(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void Rewinding(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void CatchingUp(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void Active(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void Replaying(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void OffsetIsAtTail(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void ClearingFailedPartitions(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void ClearingRecoveringPartitions(this ILogger<Observer> logger, Guid observerId, Guid microserviceId, Guid eventSequenceId, Guid tenantId);
    ...
    internal static partial void Activating(this ILogger<Observer> logger, Guid observerId, Guid eventSequenceId, Guid microserviceId, Guid tenantId, Guid sourceMicroserviceId, Guid sourceTenantId);
    ...
    internal static partial void SubscribingToStream(this ILogger<Observer> logger, Guid observerId, Guid eventSequenceId, Guid microserviceId, Guid tenantId, Guid streamId, string streamNamespace);
    ...
    internal static partial void EventReceived(this ILogger<Observer> logger, Guid eventTypeId, Guid observerId, Guid eventSequenceId, Guid microserviceId, Guid tenantId);
    ...
    internal static partial void Deactivating(this ILogger<Observer> logger, Guid observerId, Guid eventSequenceId, Guid microserviceId, Guid tenantId, Guid sourceMicroserviceId, Guid sourceTenantId);
}
