...
{
    [LoggerMessage(0, LogLevel.Debug, "Appending '{EventName}-{EventType}' for EventSource {EventSource} with sequence number {SequenceNumber} to event sequence '{EventSequenceId} for event store {EventStore} on tenant {Namespace}")]
    ...
    [LoggerMessage(1, LogLevel.Debug, "Compensating event @ {SequenceNumber} in event sequence {EventSequenceId} - event type '{EventType}' for event store '{EventStore}' on tenant {Namespace}")]
    ...
    [LoggerMessage(2, LogLevel.Critical, "Failed appending event type '{EventType}' at sequence {SequenceNumber} for event source {EventSourceId} to stream {StreamId} for event store '{EventStore}' on tenant {Namespace}")]
    ...
    [LoggerMessage(3, LogLevel.Error, "Error when appending event at sequence {SequenceNumber} for event source {EventSourceId} to event sequence {EventSequenceId} for event store {EventStore} on tenant {Namespace}")]
    ...
    [LoggerMessage(4, LogLevel.Information, "Redacting event @ {SequenceNumber} in event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace}")]
    ...
    [LoggerMessage(5, LogLevel.Information, "Redacting events with event source id {EventSourceId} and event types {EventTypes} in event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace}")]
    ...
    [LoggerMessage(6, LogLevel.Debug, "Getting tail sequence number for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
    ...
    [LoggerMessage(7, LogLevel.Debug, "Sequence number is {SequenceNumber} when getting tail sequence number for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
    ...
    [LoggerMessage(8, LogLevel.Error, "Failed getting tail sequence number for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
    ...
    [LoggerMessage(9, LogLevel.Debug, "Getting tail sequence number greater or equal than {SequenceNumber} for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
    ...
    [LoggerMessage(10, LogLevel.Error, "Failed getting tail sequence number greater or equal than {SequenceNumber} for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
    ...
    [LoggerMessage(11, LogLevel.Debug, "Sequence number is {Result} when getting tail sequence number greater or equal than {SequenceNumber} for event types from event sequence {EventSequenceId} for event store '{EventStore}' on tenant {Namespace} for event types {EventTypes}")]
