...
internal static partial class ConnectedClientsLogMessages
{
    ...
    [LoggerMessage(1, LogLevel.Information, "Disconnected client for microservice '{MicroserviceId}' with connection identifier '{ConnectionId}'. Reason: {Reason}")]
    internal static partial void ClientDisconnected(this ILogger<ConnectedClients> logger, string microserviceId, string connectionId, string reason);
}
