...
public class when_handling_a_mutation_that_ignores_antiforgery : given.a_cookie_antiforgery_middleware
{
    void Establish()
    {
        _context.Request.Method = HttpMethods.Post;
        _context.SetEndpoint(new Endpoint(
            _ => Task.CompletedTask,
            new EndpointMetadataCollection(new IgnoreAntiforgeryTokenAttribute()),
            "token"));
    }
