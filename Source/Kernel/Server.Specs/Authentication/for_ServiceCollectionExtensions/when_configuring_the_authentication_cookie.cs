...
public class when_configuring_the_authentication_cookie : given.chronicle_authentication_services
{
    ...
    [Fact] void should_keep_the_cookie_http_only() => _result.Cookie.HttpOnly.ShouldBeTrue();
    [Fact] void should_use_lax_same_site() => _result.Cookie.SameSite.ShouldEqual(SameSiteMode.Lax);
}
