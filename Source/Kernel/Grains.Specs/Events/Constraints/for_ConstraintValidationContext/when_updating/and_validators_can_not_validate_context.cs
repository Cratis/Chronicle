...
public class and_validators_can_not_validate_context : given.two_validators_that_are_index_updaters
{
    ...
    void Establish()
    {
        ...
        _secondValidator.CanValidate(Arg.Any<ConstraintValidationContext>()).Returns(false);
    ...
    [Fact] void should_call_the_first_validator() => _firstValidatorIndexUpdater.DidNotReceive().Update(_sequenceNumber);
    [Fact] void should_call_the_second_validator() => _secondValidatorIndexUpdater.DidNotReceive().Update(_sequenceNumber);
}
