...
public class and_last_handled_event_is_greater_than_current_last_handled : given.the_observer
{
    ...
    [Fact] void should_not_start_catchup_job() => _jobsManager.DidNotReceive().Start<ICatchUpObserverPartition, CatchUpObserverPartitionRequest>(
