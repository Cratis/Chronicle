...
{
    void Establish() => _storedState = _storedState with { RunningState = ObserverRunningState.Replaying };
    ...
    [Fact] void should_transition_to_replay() => _observer.Received(1).TransitionTo<ResumeReplay>();
}
