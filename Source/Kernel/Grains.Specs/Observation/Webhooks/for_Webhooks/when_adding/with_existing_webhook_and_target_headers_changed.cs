...
public class with_existing_webhook_and_target_headers_changed : given.a_webhooks_service_grain
{
    ...
    [Fact] void should_append_target_headers_set_event() =>
        _eventSequence.Received(1).Append(
            Arg.Is<EventSourceId>(id => id.Value == "test-webhook"),
            Arg.Any<TargetHeadersSetForWebhook>(),
