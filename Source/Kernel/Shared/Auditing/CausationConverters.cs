...
public static class CausationConverters
{
    ...
    public static IEnumerable<Causation> ToKernel(this IEnumerable<Chronicle.Contracts.Auditing.Causation> causations) =>
    ...
    public static Causation ToKernel(this Chronicle.Contracts.Auditing.Causation causation) =>
