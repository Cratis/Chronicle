...
/// </summary>
public class and_the_constraint_is_scoped_to_every_dimension : given.a_unique_event_types_constraints_storage
{
    ...
    async Task Establish() => await Append(0, _checkedOutEventType, _borrower, _loan, _loans, _thisBranch);
