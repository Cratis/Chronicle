...
public class and_clearing_under_an_absent_parent : Specification
{
    InMemorySink _sink;
    Key _key;
    ...
    [Fact] void should_not_create_the_parent() => ((IDictionary<string, object?>)_result!).ContainsKey("outer").ShouldBeFalse();
    [Fact] void should_preserve_its_sibling() => ((IDictionary<string, object?>)_result!)["sibling"].ShouldEqual("kept");
}
