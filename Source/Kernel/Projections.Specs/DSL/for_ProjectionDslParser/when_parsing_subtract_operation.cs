...
public class when_parsing_subtract_operation : Specification
{
...
| balance-PaymentMade.amount";
    ...
    [Fact] void should_set_subtract_expression() => _result.From.First().Value.Properties[new("balance")].ShouldEqual("$subtract(amount)");
}
