...
public class when_parsing_decrement_operation : Specification
{
...
| currentOrderCount decrement by OrderCompleted";
    ...
    [Fact] void should_set_decrement_expression() => _result.From.First().Value.Properties[new("currentOrderCount")].ShouldEqual("$decrement");
}
