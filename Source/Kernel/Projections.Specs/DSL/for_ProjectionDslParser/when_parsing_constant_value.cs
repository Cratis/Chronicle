...
public class when_parsing_constant_value : Specification
{
...
| status=""active"" on UserRegistered";
    ...
    [Fact] void should_set_constant_value() => _result.From.First().Value.Properties[new("status")].ShouldEqual("\"active\"");
}
