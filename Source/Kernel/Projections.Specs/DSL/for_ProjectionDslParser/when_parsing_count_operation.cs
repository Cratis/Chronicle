...
public class when_parsing_count_operation : Specification
{
    const string Dsl = @"Users
| orderCount count OrderCompleted";
    ...
    [Fact] void should_set_count_expression() => _result.From.First().Value.Properties[new("orderCount")].ShouldEqual("$count");
}
