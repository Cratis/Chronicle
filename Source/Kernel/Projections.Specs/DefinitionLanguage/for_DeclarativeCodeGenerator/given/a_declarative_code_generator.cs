...
namespace Cratis.Chronicle.Projections.DefinitionLanguage.for_DeclarativeCodeGenerator.given;

public class a_declarative_code_generator : Specification
{
    protected DeclarativeCodeGenerator _generator = null!;
    ...
    void Establish()
    {
        _generator = new DeclarativeCodeGenerator();
    }
