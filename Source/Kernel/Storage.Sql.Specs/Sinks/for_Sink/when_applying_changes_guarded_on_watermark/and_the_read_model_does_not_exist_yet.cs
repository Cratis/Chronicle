...
/// <summary>
/// A guarded write is an update only. Pinning it here keeps the SQL sink from diverging from MongoDB, where a
/// conditional upsert would surface the already-applied case as a duplicate key error.
/// </summary>
