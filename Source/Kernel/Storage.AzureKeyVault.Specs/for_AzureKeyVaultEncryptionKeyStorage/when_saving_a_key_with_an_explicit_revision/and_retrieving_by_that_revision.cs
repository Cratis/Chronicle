...
using context = Cratis.Chronicle.Storage.AzureKeyVault.for_AzureKeyVaultEncryptionKeyStorage.when_saving_a_key_with_an_explicit_revision.and_retrieving_by_that_revision.context;

namespace Cratis.Chronicle.Storage.AzureKeyVault.for_AzureKeyVaultEncryptionKeyStorage.when_saving_a_key_with_an_explicit_revision;

[Collection(AzureKeyVaultCollection.Name)]
public class and_retrieving_by_that_revision(context ctx) : IClassFixture<context>
{
    public class context(AzureKeyVaultFixture fixture) : given.a_azure_key_vault_encryption_key_storage(fixture)
    {
