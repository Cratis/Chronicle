...
/// <summary>
/// Represents the 32-byte version 1 digest of an event sequence mutation terminal receipt.
/// </summary>
public sealed class EventSequenceMutationReceiptDigestV1 : IEquatable<EventSequenceMutationReceiptDigestV1>
{
    readonly byte[] _bytes;

    /// <summary>
    /// Initializes a new instance of the <see cref="EventSequenceMutationReceiptDigestV1"/> class.
    /// </summary>
    ...
    public EventSequenceMutationReceiptDigestV1(ReadOnlySpan<byte> bytes) =>
        _bytes = EventSequenceMutationDigestBytes.CopyAndValidate<EventSequenceMutationReceiptDigestV1>(bytes);
    ...
    public static bool operator ==(EventSequenceMutationReceiptDigestV1? left, EventSequenceMutationReceiptDigestV1? right) => Equals(left, right);
    ...
    /// <inheritdoc/>
    public bool Equals(EventSequenceMutationReceiptDigestV1? other) => other is not null && _bytes.AsSpan().SequenceEqual(other._bytes);

    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is EventSequenceMutationReceiptDigestV1 other && Equals(other);
