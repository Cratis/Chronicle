...
/// </summary>
/// <param name="BaseType">The base <see cref="EventType"/> for the definition.</param>
...
/// </remarks>
public record FromDerivatives(EventType BaseType, IEnumerable<EventType> EventTypes, FromDefinition From);
