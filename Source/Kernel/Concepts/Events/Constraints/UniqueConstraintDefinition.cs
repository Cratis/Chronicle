...
public record UniqueConstraintDefinition(ConstraintName Name, Func<EventType, ConstraintViolationMessage> MessageCallback, IEnumerable<EventTypeAndProperty> EventsWithProperties);
