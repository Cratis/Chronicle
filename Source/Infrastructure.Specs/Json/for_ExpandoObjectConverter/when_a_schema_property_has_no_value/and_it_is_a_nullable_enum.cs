...
/// has to decide about. Deciding it by materializing the CLR default writes a literal <c language="csharp">0</c> for an enum, and a
...
/// declares <c language="csharp">enum: [1, 2, 3, 4]</c>. A reader either refuses it - taking down a whole observable query rather
...
/// </para>
/// <para>
/// The nullability marker the converter tested was a trailing <c language="csharp">?</c> on the property's <c language="csharp">format</c>, which an
/// enum does not carry: its nullability lives in the <c language="csharp">type</c> array. So a nullable enum was treated as
