...
/// whole result. <c language="csharp">feedback</c> and <c language="csharp">decision</c> are the two subjects that separate them - a nullable enum
...
/// be written.
/// <para>
/// The shapes are the generator's, not invented for the fixture: a real <c language="csharp">enum? Reason</c> renders as
/// <c language="json">{"type":["integer","null"],"enum":[...],"x-enumNames":[...]}</c> and its non-nullable counterpart as the
/// same without <c language="csharp">"null"</c> - see <c language="csharp">for_JsonSchemaGenerator.when_generating_schema_for_a_type_with_an_enum</c>,
