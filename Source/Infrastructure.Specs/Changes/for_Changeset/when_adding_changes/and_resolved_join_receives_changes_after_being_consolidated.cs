...
/// <summary>
/// A consolidated <see cref="ResolvedJoin"/> is removed from the parent, but its changeset stays linked
/// to the child it was merged into so later changes still reach the child.
/// </summary>
public class and_resolved_join_receives_changes_after_being_consolidated : given.a_changeset_with_parent
{
    ...
    [Fact] void should_apply_the_later_property_change_to_the_child() => ((IDictionary<string, object?>)_child)["description"].ShouldEqual("Updated Description");
