...
namespace Cratis.Extensions.Dolittle.Schemas
{
    ...
    public interface ISchemaStore
    {
        ...
        /// </summary>
        /// <param name="type"><see cref="global::Dolittle.SDK.Events.EventTypeId"/> to check for.</param>
        ...
        /// </remarks>
        Task<bool> HasFor(global::Dolittle.SDK.Events.EventTypeId type, Generation? generation = default);

        /// <summary>
        /// Gets a <see cref="EventSchema"/> for a specific <see cref="Type"/>.
        /// </summary>
        /// <param name="type"><see cref="global::Dolittle.SDK.Events.EventTypeId"/> to get for.</param>
        /// <param name="generation">Optional <see cref="Generation"/>.</param>
        /// <returns><see cref="EventSchema"/> for the type.</returns>
        /// <remarks>
        /// If generation is not provided, it will get what is associated with the <see cref="EventType"/>.
        /// </remarks>
        Task<EventSchema> GetFor(global::Dolittle.SDK.Events.EventTypeId type, Generation? generation = default);
    }
}
