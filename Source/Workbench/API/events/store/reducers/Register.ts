...
const routeTemplate = Handlebars.compile('/api/events/store/{{microserviceId}}/reducers/register/{{connectionId}}');
...
export class Register extends Command<IRegister> implements IRegister {
    readonly route: string = '/api/events/store/{{microserviceId}}/reducers/register/{{connectionId}}';
