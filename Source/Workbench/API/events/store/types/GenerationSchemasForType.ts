...
const routeTemplate = Handlebars.compile('/api/events/store/{microserviceId}/types/schemas/{{eventTypeId}}?microserviceId={{microserviceId}}');
...
export class GenerationSchemasForType extends QueryFor<any[], GenerationSchemasForTypeArguments> {
    readonly route: string = '/api/events/store/{microserviceId}/types/schemas/{{eventTypeId}}?microserviceId={{microserviceId}}';
