...
export interface IDJob {
    microserviceId?: string;
    tenantId?: string;
    jobId?: string;
}

export class DJobValidator extends CommandValidator {
...
export class DJob extends Command<IDJob> implements IDJob {
    readonly route: string = '/api/events/store/{{microserviceId}}/{{tenantId}}/jobs/{{jobId}}/stop/';
    readonly routeTemplate: Handlebars.TemplateDelegate = routeTemplate;
    readonly validation: CommandValidator = new DJobValidator();
    ...
    static use(initialValues?: IDJob): [DJob, SetCommandValues<IDJob>, ClearCommandValues] {
        return useCommand<DJob, IDJob>(DJob, initialValues);
    }
}
