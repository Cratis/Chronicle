...
const routeTemplate = Handlebars.compile('/api/events/store/{{microserviceId}}/{{tenantId}}/observers/{{observerId}}/rewind');
...
export class Rewind extends Command<IRewind> implements IRewind {
    readonly route: string = '/api/events/store/{{microserviceId}}/{{tenantId}}/observers/{{observerId}}/rewind';
