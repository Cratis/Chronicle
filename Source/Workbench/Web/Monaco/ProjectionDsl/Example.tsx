...
import { ProjectionDslEditor } from './ProjectionDslEditor';

/**
 * Example component demonstrating the ProjectionDslEditor with a User read model
 */
export const ProjectionDslEditorExample: React.FC = () => {
...
| ]`);
    ...
    return (
        <div style={{ padding: '20px' }}>
            <h2>Projection DSL Editor</h2>
            <p>
                This editor provides syntax highlighting, validation, and IntelliSense for the Projection DSL.
                Try typing <code>|</code> to start a new statement and see code completion suggestions.
            </p>
...
export default ProjectionDslEditorExample;
