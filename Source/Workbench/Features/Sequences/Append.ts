// @generated by Cratis. Source: Cratis.Chronicle.Sequences.Append. Time: 2026-09-08T14:33:09.1992110Z. Hash: BB39AC2A17C138B3B3FCCB55B8988F190D17E9D54A5C1E1F9D12DC163B3F66DF
/*---------------------------------------------------------------------------------------------
...
export class AppendValidator extends CommandValidator<IAppend> {
    constructor() {
        super();
        this.ruleFor(c => c.content).notEmpty().withMessage('Event content is required.');
