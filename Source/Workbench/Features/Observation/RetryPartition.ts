// @generated by Cratis. Source: Cratis.Chronicle.Observation.RetryPartition. Time: 2026-09-08T10:51:03.6881010Z. Hash: 1E11CCA29C58C9FCE7F1090627872A321CD4EED825208DF27A348138B6ABB8C9
/*---------------------------------------------------------------------------------------------
...
import { PartitionRecoveryOutcome } from '../Concepts/Observation/PartitionRecoveryOutcome';
 ...
 * Represents the command for retrying the recovery of a failed partition in an observer.
 */
export class RetryPartition extends Command<IRetryPartition, PartitionRecoveryOutcome> implements IRetryPartition {
