// @generated by Cratis. Source: Cratis.Chronicle.Api.Jobs.JobQueries. Time: 2026-04-14T16:04:04.2330510Z. Hash: 778B4F829E8B64A0011BA41E2F366A45F088597A83DC7D0D33E0B825EC135B92
/*---------------------------------------------------------------------------------------------
...
export class AllJobs extends ObservableQueryFor<Job[], AllJobsParameters> {
    ...
    readonly queryName: string = 'Cratis.Chronicle.Api.Jobs.JobQueries.AllJobs';
    ...
    static useSuspense(args?: AllJobsParameters, sorting?: Sorting): [QueryResultWithState<Job[]>, SetSorting] {
        return useSuspenseObservableQuery<Job[], AllJobs, AllJobsParameters>(AllJobs, args, sorting);
    }
    ...
    static useChangeStream(args?: AllJobsParameters, getKey?: (item: Job) => unknown, sorting?: Sorting): ChangeSet<Job> {
        return useChangeStream<Job, AllJobs, AllJobsParameters>(AllJobs, args, getKey, sorting);
    }
