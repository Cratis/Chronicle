// @generated by Cratis. Source: Cratis.Chronicle.Api.EventTypes.EventTypeQueries. Time: 2026-05-07T08:37:55.3022217Z. Hash: 939652E680E7996075185926ADDBCE25E918989256402F2DFE80E202166D1931
/*---------------------------------------------------------------------------------------------
...
export class AllEventTypes extends QueryFor<EventType[], AllEventTypesParameters> {
    ...
    readonly queryName: string = 'Cratis.Chronicle.Api.EventTypes.EventTypeQueries.AllEventTypes';
    ...
    static useSuspense(args?: AllEventTypesParameters, sorting?: Sorting): [QueryResultWithState<EventType[]>, PerformQuery<AllEventTypesParameters>, SetSorting] {
        return useSuspenseQuery<EventType[], AllEventTypes, AllEventTypesParameters>(AllEventTypes, args, sorting);
    }

    static useSuspenseWithPaging(pageSize: number, args?: AllEventTypesParameters, sorting?: Sorting): [QueryResultWithState<EventType[]>, PerformQuery, SetSorting, SetPage, SetPageSize] {
        return useSuspenseQueryWithPaging<EventType[], AllEventTypes>(AllEventTypes, new Paging(0, pageSize), args, sorting);
    }

    static when(condition: boolean): QueryWhen<AllEventTypes, EventType[], AllEventTypesParameters> {
        return new QueryWhen<AllEventTypes, EventType[], AllEventTypesParameters>(AllEventTypes, condition);
    }
}
