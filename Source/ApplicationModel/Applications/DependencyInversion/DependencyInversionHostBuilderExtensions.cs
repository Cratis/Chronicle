...
using Aksio.Cratis.Applications.MongoDB;
...
public static class DependencyInversionHostBuilderExtensions
{
    ...
    public static IHostBuilder UseDefaultDependencyInversion(this IHostBuilder builder, ITypes types)
    {
        ...
        {
            containerBuilder.RegisterDefaults(types, services);
            containerBuilder.RegisterSource<MongoDBCollectionRegistrationSource>();
        });
        return builder;
    }
}
