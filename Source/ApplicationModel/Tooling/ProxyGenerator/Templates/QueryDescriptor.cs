...
public record QueryDescriptor(string Route, string Name, string Model, string Constructor, bool IsEnumerable, IEnumerable<ImportStatement> Imports, IEnumerable<RequestArgumentDescriptor> Arguments);
