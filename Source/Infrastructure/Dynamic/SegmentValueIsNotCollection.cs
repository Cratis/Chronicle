...
public class SegmentValueIsNotCollection(PropertyPath propertyPath, IPropertyPathSegment segment)
    : Exception($"Segment '{segment.Value}' in '{propertyPath}' is not a collection of ExpandoObject");
