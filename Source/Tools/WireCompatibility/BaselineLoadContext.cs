...
/// <c language="csharp">Cratis.Chronicle.Contracts</c>. The default load context binds by simple name, so the second one would
...
/// same types this process was compiled against. Isolating those too would make every <c language="csharp">[ProtoContract]</c>
