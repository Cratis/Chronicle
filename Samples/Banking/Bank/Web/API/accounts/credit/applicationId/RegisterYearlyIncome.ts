...
const routeTemplate = Handlebars.compile('/api/accounts/credit/applicationId/income/{{income}}');
...
export class RegisterYearlyIncome extends Command<IRegisterYearlyIncome> implements IRegisterYearlyIncome {
    readonly route: string = '/api/accounts/credit/applicationId/income/{{income}}';
