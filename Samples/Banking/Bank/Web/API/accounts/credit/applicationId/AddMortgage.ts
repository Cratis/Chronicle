...
const routeTemplate = Handlebars.compile('/api/accounts/credit/applicationId/mortgage/{{remaining}}');
...
export class AddMortgage extends Command<IAddMortgage> implements IAddMortgage {
    readonly route: string = '/api/accounts/credit/applicationId/mortgage/{{remaining}}';
