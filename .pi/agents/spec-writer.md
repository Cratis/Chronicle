...
description: "Specialist for writing C# specs (the in-process scenario family) and TypeScript/React specs for vertical slices. Ensures every slice has comprehensive behavior coverage following the project's BDD conventions."
...
<!-- Generated by Cratis/AI tooling/pi-agent-adapters.mjs from .ai/agents/spec-writer.md; edit the canonical file, then regenerate. -->
